...
-- - Remplacement des ENUMs de statut par une table de lookup 'status_types'.
...
CREATE TABLE aides (
    ...
    FOREIGN KEY (statut_id) REFERENCES status_types(id) ON DELETE RESTRICT ON UPDATE CASCADE,
