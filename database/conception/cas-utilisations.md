...
3.  **Le Super Administrateur (ou Administrateur Système) :**
    ...
    - Son rôle est d'administrer les comptes des autres utilisateurs (notamment les administrateurs), de définir les règles d'accès et de sécurité (rôles, permissions, politiques de mot de passe), de configurer les paramètres généraux du système, et de superviser son bon fonctionnement et son audit.
...
- **Préconditions :**
  ...
  - Le compte utilisateur a été activé (validé) par l'administrateur.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A2 : Compte inactif (non validé)**
    ...
    - 7.a. Le système vérifie le statut du compte, mais constate qu'il n'a pas encore été validé par un administrateur.
...
- **Description :** Permet à l'administrateur d'enregistrer les informations d'un nouvel adhérent potentiel dans le système de la mutuelle et de lui créer un compte utilisateur initial.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour gérer les adhérents.
  - L'administrateur dispose de toutes les informations requises concernant le nouvel adhérent (état civil, coordonnées, etc.).
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents.
  2.  L'Administrateur clique sur l'option ou le bouton "Créer un nouvel adhérent".
  ...
  4.  L'Administrateur saisit les informations requises et optionnelles du nouvel adhérent dans les champs appropriés.
  5.  L'Administrateur définit (ou le système génère automatiquement) l'identifiant (login) et le mot de passe initial/temporaire pour le compte utilisateur associé.
  6.  L'Administrateur vérifie les informations saisies.
  7.  L'Administrateur clique sur le bouton "Enregistrer" ou "Créer".
  ...
  11. Le système définit le statut initial du mutualiste (ex: "Enregistré", "En attente de validation par l'administrateur", etc.).
  ...
  13. Le système affiche un message de succès à l'Administrateur confirmant la création et l'envoi de la notification.

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation par l'Administrateur**

    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. L'Administrateur décide d'annuler l'opération avant de sauvegarder.
    - 8.a. L'Administrateur clique sur un bouton "Annuler".
    - 9.a. Le système abandonne le processus de création et redirige l'Administrateur vers la page précédente (ex: liste des adhérents). Aucune donnée n'est enregistrée.
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées**
    ...
    - 10.a. Le système maintient l'Administrateur sur le formulaire pré-rempli avec les données saisies, lui permettant de corriger les erreurs.
  ...
  - **Scénario Alternatif A3 : Login utilisateur déjà utilisé**
    ...
    - 11.a. Le système maintient l'Administrateur sur le formulaire, lui demandant de choisir un autre login.
  ...
  - **Scénario d'Exception E1 : Erreur technique lors de l'enregistrement**
    ...
    - 11.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la création a échoué en raison d'une erreur interne et de réessayer plus tard ou contacter le support.
  ...
  - **Scénario d'Exception E2 : Échec de l'envoi de la notification**
    ...
    - 14.e. Le système _crée quand même_ le mutualiste et le compte utilisateur (selon les règles, la création est prioritaire sur la notification), affiche un message de succès _avec un avertissement_ à l'Administrateur indiquant que le mutualiste a été créé mais que l'envoi de la notification a échoué. L'Administrateur devra potentiellement notifier le mutualiste manuellement ou corriger les informations de contact et retenter l'envoi.
...
- **Description :** Permet à un administrateur autorisé de modifier les informations enregistrées d'un mutualiste existant dans le système.

- **Préconditions :**

  - L'administrateur est authentifié et possède les droits nécessaires pour modifier les informations des adhérents.
  - Le mutualiste dont les informations doivent être modifiées existe dans la base de données.
  - L'administrateur a identifié le mutualiste via la fonctionnalité de recherche ou de liste.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et accède à la section de gestion des adhérents.
  2.  L'Administrateur recherche ou sélectionne le mutualiste dont il souhaite modifier les informations.
  3.  Le système affiche les informations actuelles du mutualiste dans un formulaire éditable.
  4.  L'Administrateur modifie les champs contenant les informations à mettre à jour (ex: numéro de téléphone, adresse, email, statut, etc.).
  5.  L'Administrateur vérifie les modifications apportées.
  6.  L'Administrateur clique sur le bouton "Enregistrer les modifications".
  ...
  9.  Le système enregistre un historique de la modification effectuée (date, heure, administrateur, type de modification, champs affectés).
  10. Le système affiche un message de confirmation à l'Administrateur indiquant que les informations ont été mises à jour avec succès.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de la modification**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur décide de ne pas sauvegarder les modifications.
    - 7.a. L'Administrateur clique sur un bouton "Annuler".
    - 8.a. Le système abandonne le processus de modification et redirige l'Administrateur vers la page précédente ou la vue du mutualiste sans appliquer les changements.
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées après modification**
    ...
    - 9.a. Le système maintient l'Administrateur sur le formulaire avec les modifications pour qu'il puisse corriger.

  - **Scénario d'Exception E1 : Mutualiste introuvable**

    - ... (Étapes 1 à 2 du scénario principal)
    - 3.e. Le mutualiste recherché ou sélectionné n'est pas trouvé ou n'existe plus dans le système (ex: supprimé par un autre administrateur).
    - 4.e. Le système affiche un message informant l'Administrateur que le mutualiste n'a pas été trouvé.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de la sauvegarde des modifications**
    ...
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que la modification a échoué.
...
- **Description :** Permet à un administrateur autorisé de retirer un mutualiste du système, soit en le supprimant définitivement, soit en l'archivant ou en le marquant comme inactif, selon la politique de gestion de la mutuelle.

- **Préconditions :**

  - L'administrateur est authentifié et possède les droits nécessaires pour supprimer des adhérents.
  - Le mutualiste à supprimer existe dans la base de données.
  - L'administrateur a identifié le mutualiste concerné.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents.
  2.  L'Administrateur recherche ou sélectionne le mutualiste qu'il souhaite supprimer.
  3.  Le système affiche les informations du mutualiste.
  4.  L'Administrateur clique sur l'option ou le bouton "Supprimer".
  5.  Le système affiche un message de confirmation demandant à l'Administrateur de valider son choix, et peut présenter un avertissement sur les conséquences (ex: irréversible, archivage).
  ...
  10. Le système affiche un message de confirmation à l'Administrateur indiquant que le mutualiste a été traité avec succès (ex: "Mutualiste archivé avec succès").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'opération**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur décide de ne pas poursuivre la suppression.
    - 7.a. L'Administrateur clique sur un bouton "Annuler" ou ferme la boîte de confirmation.
  ...
  - **Scénario Alternatif A2 : Suppression bloquée par des dépendances ou opérations actives**
    ...
    - 8.a. Le système affiche un message d'erreur clair à l'Administrateur expliquant pourquoi la suppression est impossible et listant les éléments bloquants (ex: "Suppression impossible : prêt n° [X] en cours").
    - 9.a. Le système ne procède pas à la suppression. L'Administrateur doit d'abord gérer les éléments bloquants.

  - **Scénario d'Exception E1 : Mutualiste introuvable**

    - ... (Étapes 1 à 2 du scénario principal)
    - 3.e. Le mutualiste recherché ou sélectionné n'est pas trouvé dans le système (ex: déjà supprimé ou erreur de recherche).
    - 4.e. Le système affiche un message d'erreur à l'Administrateur indiquant que le mutualiste n'a pas été trouvé.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'opération de suppression/archivage**
    ...
    - 9.e. Le système enregistre l'erreur technique.
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que l'opération a échoué.
...
- **Description :** Permet à un administrateur de vérifier, confirmer et finaliser l'enregistrement d'un nouveau mutualiste après la saisie initiale des données, faisant passer son statut à "Actif" ou "Validé".

- **Préconditions :**

  - L'administrateur est authentifié et dispose des droits nécessaires pour valider les adhérents.
  ...
  - L'administrateur a accès aux informations complètes de l'adhérent et aux éventuels documents justificatifs nécessaires.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents.
  2.  L'Administrateur accède à la liste ou utilise des filtres pour afficher les mutualistes dont les données sont en attente de validation.
  3.  L'Administrateur sélectionne le mutualiste à valider pour examiner ses informations.
  ...
  5.  L'Administrateur examine attentivement les informations et les documents fournis.
  6.  L'Administrateur détermine que les informations sont exactes, complètes et conformes.
  7.  L'Administrateur clique sur l'option ou le bouton "Valider".
  ...
  10. Le système enregistre l'historique de cette validation (date, heure, administrateur ayant validé).
  11. Le système affiche un message de confirmation à l'Administrateur indiquant que le mutualiste a été validé avec succès.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Validation refusée / Informations incorrectes ou incomplètes**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur examine les informations et/ou documents et constate qu'ils sont incorrects, incomplets, ou non conformes aux exigences.
    - 7.a. L'Administrateur clique sur l'option ou le bouton "Refuser la validation" ou "Marquer comme incomplet".
    - 8.a. Le système met à jour le statut du mutualiste à un état comme "Validation Refusée" ou "Informations Incomplètes".
    - 9.a. Le système peut inviter l'Administrateur à saisir un motif ou un commentaire expliquant le refus/l'état incomplet.
    - 10.a. Le système enregistre l'historique du refus de validation, incluant le motif si renseigné.
    - 11.a. Le système affiche un message de confirmation à l'Administrateur.
  ...
  - **Scénario Alternatif A2 : Annulation de l'opération de validation**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur décide de ne pas valider ni refuser pour l'instant.
    - 7.a. L'Administrateur quitte l'écran de visualisation/validation du mutualiste sans cliquer sur "Valider" ou "Refuser".
  ...
  - **Scénario d'Exception E1 : Mutualiste introuvable ou statut non valide**
    ...
    - 5.e. Le système affiche un message d'erreur à l'Administrateur.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement de la validation**
    ...
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que la validation a échoué.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    ...
    - 14.e. Le système affiche un message de succès à l'Administrateur pour la validation, mais _avec un avertissement_ indiquant que la notification n'a pas pu être envoyée.
...
- **Description :** Permet à un administrateur de changer le statut d'un mutualiste en "Suspendu" suite à l'application des règles de la mutuelle (ex: impayés de cotisations, non-respect des engagements). Cette action limite généralement l'accès du mutualiste aux services et fonctionnalités.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits requis pour modifier le statut des adhérents.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents.
  2.  L'Administrateur recherche ou sélectionne le mutualiste qu'il souhaite suspendre.
  3.  Le système affiche les informations du mutualiste, y compris son statut actuel.
  4.  L'Administrateur clique sur l'option ou le bouton "Suspendre".
  ...
  6.  L'Administrateur confirme l'action et saisit le motif si demandé.
  7.  Le système vérifie que le statut actuel du mutualiste permet la suspension et que l'Administrateur a les droits.
  ...
  10. Le système enregistre l'historique de la suspension (date, heure, administrateur, mutualiste, motif).
  11. Le système affiche un message de confirmation à l'Administrateur indiquant que le mutualiste a été suspendu avec succès.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'opération de suspension**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur décide de ne pas suspendre le mutualiste.
    - 7.a. L'Administrateur clique sur un bouton "Annuler" ou ferme la boîte de dialogue.
  ...
  - **Scénario Alternatif A2 : Motif de suspension obligatoire non fourni**
    ...
    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. Le système est configuré pour rendre le motif de suspension obligatoire, mais l'Administrateur soumet la confirmation sans le remplir.
    - 8.a. Le système affiche un message d'erreur demandant la saisie du motif.
    - 9.a. L'Administrateur doit fournir le motif pour valider l'action (retour à l'étape 6).
  ...
  - **Scénario Alternatif A3 : Mutualiste déjà dans un statut final ou non suspensible**
    ...
    - 9.a. Le système affiche un message d'erreur à l'Administrateur indiquant que l'action de suspension n'est pas possible pour ce mutualiste dans son état actuel.
  ...
  - **Scénario d'Exception E1 : Mutualiste introuvable**
    ...
    - 4.e. Le système affiche un message d'erreur à l'Administrateur.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement de la suspension**
    ...
    - 10.e. Le système enregistre l'erreur technique dans ses logs.
    - 11.e. Le système affiche un message d'erreur générique à l'Administrateur et l'opération de suspension échoue.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    ...
    - 13.e. Le système enregistre l'échec de l'envoi et peut alerter l'Administrateur.
    - 14.e. La suspension est marquée comme réussie, mais l'Administrateur est informé que la notification n'a pas pu être envoyée et pourrait devoir contacter le mutualiste manuellement.
...
- **Description :** Permet à un administrateur de rétablir le statut actif d'un mutualiste qui avait été précédemment suspendu. Cette action redonne au mutualiste l'accès à son espace personnel et à l'intégralité de ses droits et avantages d'adhésion.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour modifier le statut des adhérents.
  - Le mutualiste à réactiver existe dans le système et son statut actuel est "Suspendu".
  - L'administrateur a identifié le mutualiste et les conditions requises pour la levée de sa suspension ont été remplies (ex: apurement des cotisations impayées, résolution du problème initial).
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents.
  2.  L'Administrateur recherche ou sélectionne le mutualiste qu'il souhaite réactiver (potentiellement en filtrant sur les mutualistes suspendus - voir UC 8).
  3.  Le système affiche les informations du mutualiste, confirmant son statut actuel "Suspendu".
  4.  L'Administrateur vérifie que les raisons ayant entraîné la suspension ont été résolues (ex: consulte l'historique des paiements, vérifie les notes du dossier).
  5.  L'Administrateur clique sur l'option ou le bouton "Réactiver".
  6.  Le système peut afficher une boîte de dialogue demandant confirmation et/ou permettant à l'Administrateur de saisir un motif pour la réactivation (ex: "Situation d'impayés régularisée").
  7.  L'Administrateur confirme l'action de réactivation et saisit le motif si nécessaire.
  8.  Le système vérifie que le statut actuel du mutualiste est bien "Suspendu" et que l'Administrateur a les droits d'effectuer cette action.
  ...
  11. Le système enregistre l'historique de la réactivation (date, heure, administrateur, mutualiste, motif de réactivation).
  12. Le système affiche un message de confirmation à l'Administrateur indiquant que le mutualiste a été réactivé avec succès.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'opération de réactivation**
    ...
    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. L'Administrateur décide d'annuler l'opération.
    - 8.a. L'Administrateur clique sur un bouton "Annuler" ou ferme la boîte de dialogue de confirmation.
  ...
  - **Scénario Alternatif A2 : Motif de réactivation obligatoire non fourni**
    ...
    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. Le système exige la saisie d'un motif de réactivation, mais l'Administrateur ne le fournit pas avant de confirmer.
    - 8.a. Le système affiche un message d'erreur demandant de saisir le motif.
    - 9.a. L'Administrateur doit fournir le motif pour pouvoir continuer (retour à l'étape 7).
  ...
  - **Scénario Alternatif A3 : Mutualiste n'est pas en statut "Suspendu"**
    ...
    - 10.a. Le système affiche un message d'erreur à l'Administrateur indiquant que cette action n'est pas applicable au mutualiste dans son état actuel.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement de la réactivation**
    ...
    - 12.e. Le système affiche un message d'erreur générique à l'Administrateur et l'opération de réactivation échoue.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    ...
    - 14.e. Le système enregistre l'échec de l'envoi et peut alerter l'Administrateur (ex: "Réactivation réussie, mais notification non envoyée").
    - 15.e. La réactivation est complète du point de vue système, mais l'Administrateur pourrait devoir contacter le mutualiste par un autre moyen.
...
- **Description :** Permet à l'administrateur de consulter la liste de tous les mutualistes dont l'accès ou les droits ont été temporairement retirés (statut "Suspendu"). Cette fonctionnalité est essentielle pour le suivi des adhérents nécessitant une attention particulière.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits de consultation des informations des adhérents.
  - L'interface de gestion des adhérents est accessible.

- **Postconditions :**

  - L'administrateur a consulté la liste des mutualistes actuellement suspendus. Aucune modification de données n'est effectuée par ce cas d'utilisation.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents.
  2.  L'Administrateur accède à la vue dédiée aux listes filtrées d'adhérents (par exemple, en cliquant sur un lien "Mutualistes suspendus" sur le tableau de bord ou en appliquant un filtre dans la liste générale des adhérents).
  ...
  5.  L'Administrateur consulte la liste affichée.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucun mutualiste suspendu**
    ...
    - 5.a. Le système affiche un message informant l'Administrateur qu'"Aucun mutualiste n'est actuellement suspendu" ou présente une liste vide avec cette indication.
    - 6.a. L'Administrateur prend connaissance de cette information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération des données**
    ...
    - 6.e. Le système affiche un message d'erreur à l'Administrateur indiquant que la liste des mutualistes suspendus n'a pas pu être chargée pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - Certaines modifications (ex: adresse, email) nécessitent-elles une re-validation par l'administrateur ?
...
- **Postconditions :**
  ...
  - (Optionnel) Les ayants droit ajoutés ou modifiés peuvent nécessiter une validation par l'administrateur pour être éligibles aux prestations.
...
- **Scénario principal :**
  ...
  - **Sous-Scénario Principal A : Ajouter un nouvel ayant droit**
    ...
    13a. (Optionnel) Le système marque l'ayant droit comme "En attente de validation" par l'administrateur.
  ...
  - **Sous-Scénario Principal M : Modifier un ayant droit existant**
    ...
    12m. (Optionnel) Le système peut marquer l'ayant droit comme "À re-valider" par l'administrateur si des informations sensibles ont été modifiées.
...
- **Points à considérer pour la suite :**
  ...
  - Faut-il une validation par l'administrateur après qu'un mutualiste a géré ses ayants droit ? (Cela impliquerait un autre UC côté Admin "Valider les ayants droit d'un mutualiste" et un workflow de notification).
...
- **Points à considérer pour la suite :**
  ...
  - Comment la carte est-elle générée initialement ? Est-ce manuel par l'administrateur ou automatique lors de la validation (UC 5) ?
...
- **Description :** Permet à un administrateur autorisé d'enregistrer un nouveau prêt accordé à un mutualiste, en définissant les conditions financières et les modalités de remboursement.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour créer et gérer les prêts.
  ...
  - L'administrateur dispose de toutes les informations et conditions du prêt à enregistrer (montant, taux, durée, accord formel du prêt si un processus d'approbation existe en amont).
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des prêts.
  2.  L'Administrateur clique sur l'option ou le bouton "Créer un nouveau prêt".
  3.  Le système affiche un formulaire de saisie pour les informations du nouveau prêt.
  4.  L'Administrateur utilise la fonction de recherche ou de sélection pour trouver et associer le mutualiste bénéficiaire du prêt.
  5.  Le système peut afficher un résumé de l'éligibilité du mutualiste ou de son historique de prêts pour aider l'Administrateur.
  6.  L'Administrateur saisit les détails du prêt :
  ...
  7.  L'Administrateur vérifie les informations saisies.
  8.  L'Administrateur clique sur le bouton "Enregistrer" ou "Créer le prêt".
  ...
  13. Le système affiche un message de confirmation à l'Administrateur (ex: "Prêt créé avec succès. Échéancier généré.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation par l'Administrateur**
    ...
    - ... (Étapes 1 à 7 du scénario principal)
    - 8.a. L'Administrateur décide d'annuler la création.
    - 9.a. L'Administrateur clique sur le bouton "Annuler".
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées lors de la validation**
    ...
    - 10.a. Le système affiche des messages d'erreur à côté des champs concernés. L'Administrateur reste sur le formulaire pour corriger.
  ...
  - **Scénario Alternatif A3 : Mutualiste sélectionné n'est pas éligible (vérification métier)**
    ...
    - 10.a. Le système affiche un message d'erreur à l'Administrateur expliquant la raison du refus métier. Le processus de création est arrêté pour ce mutualiste.
  ...
  - **Scénario Alternatif A4 : Paramètres du prêt non conformes aux règles métier (taux, durée, etc.)**
    ...
    - 10.a. Le système affiche un message d'erreur indiquant la violation (ex: "Le taux d'intérêt appliqué est supérieur au maximum autorisé"). L'Administrateur doit corriger les paramètres.
  ...
  - **Scénario d'Exception E1 : Mutualiste introuvable lors de la sélection**
    ...
    - 6.e. Le système affiche un message d'erreur à l'Administrateur. L'opération de création ne peut pas démarrer.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement du prêt ou de l'échéancier**
    ...
    - 13.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que la création a échoué. L'opération n'est pas finalisée.

  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    - ... (Étapes 1 à 13 du scénario principal)
    - 14.e. Le système tente d'envoyer la notification au mutualiste mais l'envoi échoue.
    - 15.e. Le système enregistre l'échec et peut alerter l'Administrateur (ex: "Prêt créé, mais notification non envoyée").
...
- **Description :** Permet à un administrateur de consulter le solde restant dû (l'encours) d'un prêt spécifique accordé à un mutualiste, ainsi que des informations clés sur l'état d'avancement de son remboursement.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour consulter les informations des prêts.
  - Le prêt concerné existe dans le système et est associé à un mutualiste.
  - L'administrateur a identifié le prêt dont il souhaite consulter l'encours via une liste ou une recherche.

- **Postconditions :**

  - L'administrateur a pu consulter les informations de l'encours et le résumé de l'état du prêt. Aucune modification de données n'est effectuée par ce cas d'utilisation.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des prêts.
  2.  L'Administrateur recherche ou sélectionne le prêt spécifique dont il souhaite visualiser l'encours (par exemple, en filtrant les prêts par mutualiste, par statut, ou en cherchant une référence de prêt).
  ...
  6.  L'Administrateur consulte les informations affichées pour le prêt.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Prêt introuvable ou non accessible**
    ...
    - ... (Étapes 1 à 3 du scénario principal)
    - 4.a. Le système ne trouve pas le prêt sélectionné/recherché, ou l'Administrateur n'a pas les droits d'accès à ce prêt spécifique.
    - 5.a. Le système affiche un message d'erreur à l'Administrateur indiquant que le prêt n'a pas été trouvé ou n'est pas accessible.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération ou du calcul des données**
    ...
    - 7.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que les informations du prêt n'ont pas pu être chargées pour le moment.
...
- **Description :** Permet à un administrateur d'envoyer manuellement un message de rappel ou d'avertissement à un mutualiste, généralement en cas de retard dans le remboursement d'une échéance de prêt. La communication peut se faire via la messagerie interne du système ou par SMS.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour envoyer des communications et des relances.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des prêts, une liste des échéances en retard, ou le dossier d'un mutualiste spécifique.
  2.  L'Administrateur identifie le mutualiste ou le prêt nécessitant une relance (potentiellement en consultant une liste de retards générée par le système).
  3.  L'Administrateur sélectionne le mutualiste/prêt et choisit l'action "Envoyer une relance" ou similaire.
  ...
  5.  L'Administrateur choisit la méthode de communication (Messagerie Interne ou SMS).
  6.  L'Administrateur sélectionne un modèle de message ou rédige le contenu du message. Le système peut permettre l'insertion de variables (ex: nom du mutualiste, montant de l'échéance en retard, date).
  7.  L'Administrateur vérifie le contenu et le destinataire(s).
  8.  L'Administrateur clique sur le bouton "Envoyer".
  ...
  12. Le système affiche un message de confirmation à l'Administrateur indiquant que la relance a été envoyée ou soumise pour envoi.

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation de l'envoi par l'Administrateur**

    - ... (Étapes 1 à 7 du scénario principal)
    - 8.a. L'Administrateur décide d'annuler l'envoi de la relance.
    - 9.a. L'Administrateur clique sur "Annuler" ou quitte l'interface d'envoi.
    - 10.a. Le système abandonne l'opération.

  - **Scénario Alternatif A2 : Absence de situation justifiant une relance (règle métier)**

    - ... (Étapes 1 à 3 du scénario principal)
    - 4.a. L'Administrateur sélectionne l'option de relance pour un mutualiste qui n'a pas de retards selon les critères du système (ex: toutes les échéances sont à jour).
  ...
  - **Scénario Alternatif A3 : Coordonnées de contact manquantes ou invalides pour la méthode choisie**
    ...
    - 10.a. Le système affiche un message d'erreur à l'Administrateur informant de l'échec de la vérification des coordonnées et que la relance ne peut être envoyée par ce canal. L'Administrateur peut être invité à mettre à jour le profil ou à choisir une autre méthode.
  ...
  - **Scénario d'Exception E2 : Erreur technique ou indisponibilité du service d'envoi (SMS ou Messagerie Interne)**
    ...
    - 12.e. Le système affiche un message d'erreur à l'Administrateur indiquant que l'envoi a échoué techniquement et de réessayer ou contacter le support. La relance n'est pas reçue par le mutualiste.
...
- **Préconditions :**
  ...
  - L'administrateur dispose de toutes les informations et conditions du rachat de prêt à enregistrer (montant racheté, taux, durée, etc.).
  - (Optionnel) L'administrateur dispose des documents ou preuves liés à la dette rachetée si la procédure l'exige.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des rachats de prêts (ou la sous-section dédiée dans la gestion des prêts).
  2.  L'Administrateur clique sur l'option ou le bouton "Créer un nouveau rachat de prêt".
  3.  Le système affiche un formulaire de saisie spécifique aux rachats de prêts.
  4.  L'Administrateur utilise la fonction de recherche ou de sélection pour trouver et associer le mutualiste bénéficiaire du rachat de prêt.
  ...
  6.  L'Administrateur saisit les détails du rachat de prêt accordé :
  ...
  7.  L'Administrateur vérifie les informations saisies.
  8.  L'Administrateur clique sur le bouton "Enregistrer" ou "Créer Rachat de Prêt".
  ...
  13. Le système affiche un message de confirmation à l'Administrateur (ex: "Rachat de prêt créé avec succès. Échéancier généré.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A3 : Mutualiste sélectionné n'est pas éligible au rachat (vérification métier)**
    ...
    - 10.a. Le système affiche un message d'erreur à l'Administrateur expliquant la raison. Le processus de création est arrêté.
  ...
  - **Scénario Alternatif A4 : Paramètres du rachat non conformes aux règles métier**
    ...
    - 10.a. Le système affiche un message d'erreur indiquant la violation. L'Administrateur doit corriger les paramètres.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement du rachat ou de l'échéancier**
    ...
    - 12.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que la création a échoué. L'opération n'est pas finalisée.

  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    - ... (Étapes 1 à 13 du scénario principal)
    - 14.e. Le système tente d'envoyer la notification au mutualiste mais l'envoi échoue.
    - 15.e. Le système enregistre l'échec et peut alerter l'Administrateur (ex: "Rachat de prêt créé, mais notification non envoyée").
...
- **Description :** Permet à un administrateur de consulter le solde restant dû (l'encours) d'un rachat de prêt spécifique accordé à un mutualiste, afin de suivre son état financier et l'avancement de son remboursement.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour consulter les informations des rachats de prêts.
  - Le rachat de prêt concerné existe dans le système et est associé à un mutualiste.
  - L'administrateur a identifié le rachat de prêt dont il souhaite visualiser l'encours (via une liste, une recherche, ou le dossier du mutualiste).

- **Postconditions :**

  - L'administrateur a pu consulter l'encours et les informations de résumé du rachat de prêt sélectionné. Aucune modification de données n'est effectuée par ce cas d'utilisation.
  - Les informations de l'encours et du résumé du rachat sont affichées à l'écran.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des rachats de prêts (ou la section des prêts avec un filtre "Rachat").
  2.  L'Administrateur recherche ou sélectionne le rachat de prêt spécifique dont il souhaite visualiser l'encours (par exemple, en parcourant une liste, en cherchant par mutualiste ou par référence de rachat).
  ...
  6.  L'Administrateur consulte les informations affichées pour le rachat de prêt.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Rachat de prêt introuvable ou non accessible**
    ...
    - ... (Étapes 1 à 3 du scénario principal)
    - 4.a. Le système ne trouve pas le rachat de prêt sélectionné/recherché, ou l'Administrateur n'a pas les droits d'accès à ce rachat spécifique.
    - 5.a. Le système affiche un message d'erreur à l'Administrateur indiquant que le rachat de prêt n'a pas été trouvé ou n'est pas accessible.
    - 6.a. L'opération de visualisation ne peut pas se poursuivre.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération ou du calcul des données**
    ...
    - 6.e. Le système enregistre l'erreur technique dans ses journaux.
    - 7.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que les informations du rachat de prêt n'ont pas pu être chargées pour le moment.
...
- **Description :** Permet à un administrateur autorisé d'enregistrer formellement dans le système l'attribution d'une aide, qu'elle soit financière (numéraire) ou en nature (matérielle), à un mutualiste.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour enregistrer les aides.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des aides (ou accède au dossier du mutualiste bénéficiaire et initie l'action depuis là).
  2.  L'Administrateur clique sur l'option ou le bouton "Enregistrer une nouvelle aide", "Attribuer une aide", ou similaire.
  3.  Le système affiche un formulaire de saisie pour les informations relatives à l'aide.
  4.  L'Administrateur recherche et sélectionne le mutualiste bénéficiaire de l'aide.
  5.  L'Administrateur choisit le type d'aide parmi une liste prédéfinie (ex: Aide Numéraire, Aide Matérielle, Aide Décès, etc.).
  6.  Selon le type d'aide choisi, le système ajuste le formulaire pour demander les informations spécifiques :
      - **Si Type = Aide Numéraire :** L'Administrateur saisit le montant exact de l'aide financière accordée.
      - **Si Type = Aide Matérielle :** L'Administrateur saisit une description du bien matériel (ex: fauteuil roulant, béquilles, kit scolaire), sa valeur estimée, et potentiellement des informations supplémentaires comme une référence d'inventaire si la mutuelle gère ses biens.
  7.  L'Administrateur renseigne la date à laquelle l'aide a été attribuée ou décidée.
  8.  (Optionnel) L'Administrateur ajoute une description ou un motif pour l'aide (ex: "Suite à accident de la route", "Soutien rentrée scolaire").
  9.  L'Administrateur vérifie les informations saisies.
  10. L'Administrateur clique sur le bouton "Enregistrer" ou "Attribuer l'aide".
  ...
  14. Le système affiche un message de confirmation à l'Administrateur indiquant que l'aide a été enregistrée avec succès.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation par l'Administrateur**
    ...
    - ... (Étapes 1 à 10 du scénario principal)
    - 11.a. L'Administrateur décide d'annuler l'opération.
    - 12.a. L'Administrateur clique sur "Annuler".
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées**
    ...
    - 13.a. Le système affiche des messages d'erreur clairs à côté des champs concernés. L'Administrateur reste sur le formulaire pour corriger.

  - **Scénario d'Exception E1 : Mutualiste introuvable lors de la sélection**

    - ... (Étapes 1 à 4 du scénario principal)
    - 5.e. Le mutualiste recherché ou sélectionné n'est pas trouvé ou n'existe plus dans le système.
    - 6.e. Le système affiche un message d'erreur à l'Administrateur. L'opération ne peut pas démarrer.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement de l'aide**
    ...
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que l'enregistrement de l'aide a échoué. L'aide n'est pas enregistrée.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    ...
    - 17.e. Le système enregistre l'échec de l'envoi et peut alerter l'Administrateur (ex: "Aide enregistrée, mais notification non envoyée").
...
- **Description :** Permet à un administrateur de consulter une liste récapitulative de toutes les aides (qu'elles soient numéraires ou matérielles) qui ont été attribuées à l'ensemble des mutualistes sur une période donnée ou depuis le début, afin d'avoir une vue d'ensemble et de pouvoir effectuer un suivi global.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour consulter l'ensemble des informations relatives aux aides.
  - Le système contient des enregistrements d'aides accordées.

- **Postconditions :**

  - L'administrateur a consulté la liste de toutes les aides enregistrées dans le système. Aucune modification des données n'est effectuée.
  - La liste des aides est affichée à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion ou de consultation des aides.
  2.  L'Administrateur sélectionne l'option pour afficher la liste complète de toutes les aides accordées (ex: un onglet "Liste de toutes les aides").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucune aide enregistrée dans le système**
    ...
    - 6.a. L'Administrateur prend connaissance de l'information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération de la liste des aides**
    ...
    - 5.e. Le système enregistre l'erreur technique dans ses journaux.
    - 6.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la liste des aides n'a pas pu être chargée pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - En cliquant sur une ligne de la liste, l'Administrateur peut-il accéder aux détails complets de l'aide ou au dossier du mutualiste bénéficiaire ? (Nécessiterait un ou plusieurs autres UC(s) de consultation détaillée/modification des aides).
  - L'Administrateur doit-il pouvoir exporter cette liste (ce serait un cas d'utilisation distinct) ?
...
- **Description :** Permet à un administrateur d'enregistrer et de formaliser une prise en charge pour un mutualiste ou un de ses ayants droit. Cela implique de documenter la dépense concernée, le montant validé par la mutuelle, et de définir le statut de cette prise en charge.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour gérer les prises en charge.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des prises en charge.
  2.  L'Administrateur clique sur l'option "Créer une nouvelle prise en charge" ou sélectionne un dossier de demande de prise en charge à traiter/enregistrer.
  3.  Le système affiche un formulaire de saisie pour les informations de la prise en charge.
  4.  L'Administrateur recherche et sélectionne le mutualiste principal concerné.
  5.  L'Administrateur sélectionne potentiellement l'ayant droit si la prise en charge concerne un ayant droit du mutualiste.
  6.  L'Administrateur choisit la catégorie de la prise en charge (ex: Soins Médicaux, Optique, Frais Funéraires) parmi une liste prédéfinie, potentiellement liée aux prestations souscrites par le mutualiste (Module 11).
  7.  L'Administrateur saisit les détails de la dépense :
  ...
  8.  L'Administrateur définit le statut de la prise en charge (ex: "Enregistrée", "Validée pour paiement", "Payée", "Refusée").
  9.  L'Administrateur vérifie les informations saisies et le statut.
  10. L'Administrateur clique sur le bouton "Enregistrer", "Valider", ou "Enregistrer et Payer" (si le processus de paiement est intégré).
  ...
  15. Le système affiche un message de confirmation à l'Administrateur.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées**
    ...
    - 13.a. Le système affiche des messages d'erreur à côté des champs concernés. L'Administrateur reste sur le formulaire pour corriger.
  ...
  - **Scénario Alternatif A3 : Montant pris en charge dépasse les règles métier (ex: plafond de prestation)**
    ...
    - 13.a. Le système affiche un avertissement ou un message d'erreur. L'Administrateur doit ajuster le montant pour être conforme ou enregistrer une dérogation si possible.

  - **Scénario Alternatif A4 : Enregistrement avec statut "Refusée"**

    - ... (Étapes 1 à 10 du scénario principal)
    - 11.a. L'Administrateur définit délibérément le statut à "Refusée" car le dossier n'est pas éligible.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement de la prise en charge**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que l'enregistrement a échoué.
  ...
  - **Scénario d'Exception E3 : Échec du déclenchement du paiement ou de l'envoi de notification/paiement**
    ...
    - 17.e. Le système enregistre l'échec. La prise en charge est enregistrée dans le système avec le statut choisi, mais l'Administrateur est averti d'un problème avec le suivi (notification non partie, paiement non initié).
...
- **Description :** Permet à un administrateur de consulter une liste globale de toutes les prises en charge enregistrées dans le système, quel que soit leur statut ou le mutualiste concerné. Cette vue offre un aperçu complet des demandes et des dépenses liées aux prestations de la mutuelle.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour visualiser les informations relatives aux prises en charge.
  - Le système contient des enregistrements de prises en charge (potentiellement aucun, le cas est géré).

- **Postconditions :**

  - L'administrateur a consulté la liste de toutes les prises en charge enregistrées dans le système. Aucune modification des données n'est effectuée par ce cas d'utilisation.
  - La liste des prises en charge est affichée à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion ou de consultation des prises en charge.
  2.  L'Administrateur sélectionne l'option permettant d'afficher la liste de toutes les prises en charge (ex: un menu, un onglet, un bouton "Voir toutes les prises en charge").
  ...
  5.  L'Administrateur consulte la liste affichée, pouvant potentiellement utiliser des options de tri, de filtrage ou de recherche rapide si disponibles.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération des données**
    ...
    - 5.e. Le système enregistre l'erreur technique dans ses journaux.
    - 6.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la liste des prises en charge n'a pas pu être chargée pour le moment.

- **Points à considérer pour la suite :**
  - Quelles informations (colonnes) sont les plus importantes pour que l'Administrateur puisse effectuer un suivi efficace depuis cette liste ?
  ...
  - L'Administrateur doit-il pouvoir cliquer sur une ligne du tableau pour accéder à une vue détaillée de la prise en charge, potentiellement pour la modifier ou voir les documents associés ? (Nécessiterait un UC distinct comme "Visualiser/Modifier une prise en charge (Admin)").
  - L'Administrateur doit-il pouvoir exporter cette liste pour des analyses externes (ce serait un cas d'utilisation distinct) ?
...
- **Description :** Permet à l'administrateur de consulter une synthèse statistique, généralement sous forme de rapport ou graphique, identifiant les catégories de prises en charge (ex: types de soins, événements) les plus courantes ou les plus coûteuses sur une période donnée. Cela aide à analyser les besoins des adhérents et à orienter la stratégie de la mutuelle.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder aux rapports sur les prises en charge.
...
- **Postconditions :**
  ...
  - L'administrateur a consulté le rapport ou la liste des catégories de prises en charge les plus fréquentes. Aucune modification de données n'est effectuée par ce cas d'utilisation.
  - Les résultats du rapport sont affichés à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de reporting ou de statistiques, ou accède directement au tableau de bord administrateur (UC 51) qui inclut ce rapport.
  2.  L'Administrateur accède à la fonctionnalité d'analyse des prises en charge fréquentes ou consulte le widget correspondant sur le tableau de bord.
  ...
  4.  L'Administrateur configure le rapport si nécessaire et déclenche sa génération (si ce n'est pas un widget automatique).
  ...
  9.  L'Administrateur consulte le rapport pour analyser les tendances.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Données insuffisantes ou période sans prises en charge**
    ...
    - 9.a. L'Administrateur prend connaissance de l'information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la génération du rapport**
    ...
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que le rapport n'a pas pu être généré pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - L'Administrateur peut-il cliquer sur une catégorie dans le rapport pour voir la liste des prises en charge individuelles qui la composent (potentiellement en utilisant l'UC 29 avec un filtre appliqué) ?
  - Ce rapport est-il uniquement visuel ou l'Administrateur peut-il exporter les données brutes ou le rapport final ?
...
- **Description :** Permet à un administrateur autorisé d'initier formellement le processus de liquidation des droits acquis par un mutualiste ou ses bénéficiaires. Ce processus inclut le calcul des sommes dues selon les règles de la mutuelle et la préparation du versement final.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour gérer les liquidations.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des liquidations ou accède au dossier du mutualiste concerné.
  2.  L'Administrateur identifie le mutualiste ou les bénéficiaires pour lesquels une liquidation doit être lancée, potentiellement sur la base d'un événement enregistré (ex: notification de décès).
  3.  L'Administrateur sélectionne le mutualiste/bénéficiaire et choisit l'option ou le bouton "Lancer procédure de liquidation".
  ...
  5.  L'Administrateur confirme le lancement de la procédure et spécifie l'événement si nécessaire.
  ...
  11. Le système affiche un message de confirmation à l'Administrateur indiquant que la procédure de liquidation a été lancée avec succès et qu'un calcul des droits est en cours ou prêt à être effectué.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation par l'Administrateur**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur décide de ne pas lancer la procédure.
    - 7.a. L'Administrateur clique sur "Annuler".
  ...
  - **Scénario Alternatif A2 : Mutualiste/Bénéficiaire non éligible ou événement non pertinent pour la liquidation**
    ...
    - 8.a. Le système affiche un message d'erreur à l'Administrateur expliquant la raison. L'opération est stoppée.
  ...
  - **Scénario Alternatif A3 : Données historiques manquantes ou incohérentes pour le calcul**
    ...
    - 8.a. Le système affiche un avertissement ou bloque le lancement, indiquant à l'Administrateur que les données doivent être corrigées/complétées avant de lancer la liquidation.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de la création de la procédure ou du déclenchement du calcul**
    ...
    - 12.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que le lancement de la procédure a échoué.
...
- **Description :** Permet à un administrateur de visualiser l'état actuel et l'historique des différentes étapes d'une procédure de liquidation des droits (initiée via UC 32) pour un mutualiste ou ses bénéficiaires.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour consulter et suivre les procédures de liquidation.
  ...
  - L'administrateur a identifié la procédure de liquidation spécifique qu'il souhaite suivre.

- **Postconditions :**

  - L'administrateur a pu consulter toutes les informations disponibles sur l'état d'avancement de la procédure de liquidation sélectionnée. Aucune modification de données n'est effectuée par cette consultation.
  - L'état et les informations de la procédure de liquidation sont affichés à l'écran.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion et de suivi des liquidations.
  2.  L'Administrateur accède à la liste des procédures de liquidation (en cours, terminées, en attente, etc.).
  3.  L'Administrateur utilise une fonction de recherche ou des filtres, ou sélectionne directement dans la liste, la procédure de liquidation spécifique qu'il souhaite suivre.
  ...
  6.  L'Administrateur consulte les informations affichées pour prendre connaissance de l'état d'avancement et des prochaines étapes éventuelles.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucune procédure de liquidation trouvée**
    ...
    - 5.a. L'Administrateur prend connaissance de l'information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération des données de la procédure**
    ...
    - 6.e. Le système enregistre l'erreur technique dans ses journaux.
    - 7.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que les informations de la procédure n'ont pas pu être chargées pour le moment.

- **Points à considérer pour la suite :**
  - Quels sont les statuts précis que peut prendre une procédure de liquidation ?
  - Est-il possible pour l'Administrateur de _modifier_ le statut d'une procédure depuis cette vue (si le processus le permet) ? (Ce serait un UC distinct comme "Mettre à jour le statut d'une liquidation").
...
- **Description :** Permet à un administrateur de consulter la liste des documents numériques (fichiers scannés, PDF, images, etc.) qui ont été associés à une procédure de liquidation spécifique. Ces documents servent de pièces justificatives pour l'événement déclencheur, l'identification des bénéficiaires, le calcul des droits, etc.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder et visualiser les documents de liquidation.
  ...
  - L'administrateur a identifié la procédure de liquidation dont il souhaite consulter les documents.

- **Postconditions :**

  - L'administrateur a pu consulter la liste des documents associés à la liquidation sélectionnée.
  - L'administrateur a pu ouvrir et visualiser le contenu des documents sélectionnés (ou les télécharger).
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des liquidations.
  2.  L'Administrateur recherche ou sélectionne la procédure de liquidation spécifique (potentiellement depuis la vue de suivi UC 33) pour laquelle il souhaite consulter les documents.
  3.  L'Administrateur accède à la section ou à l'onglet "Documents", "Pièces Jointes", ou "Justificatifs" lié à cette procédure de liquidation spécifique.
  ...
  6.  L'Administrateur consulte la liste des documents disponibles.
  7.  L'Administrateur sélectionne un document spécifique dans la liste (ex: clique sur le nom du fichier ou une icône "Visualiser").
  8.  Le système récupère le fichier du document sélectionné.
  9.  Le système permet à l'Administrateur de visualiser le contenu du document (par exemple, en ouvrant une visionneuse intégrée, ou en initiant un téléchargement pour l'ouvrir localement).
  10. L'Administrateur examine le contenu du document.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A2 : Aucun document associé à la liquidation sélectionnée**
    ...
    - 7.a. L'Administrateur prend connaissance de l'information. La visualisation des documents pour cette procédure est terminée.

  - **Scénario Alternatif A3 : Document sélectionné introuvable ou fichier corrompu**

    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. Le système tente de récupérer le fichier du document sélectionné, mais le fichier n'est pas trouvé à l'emplacement attendu, est corrompu, ou l'Administrateur n'a pas les droits d'accès suffisants pour ce fichier spécifique.
    - 8.a. Le système affiche un message d'erreur indiquant que le document n'a pas pu être chargé ou est inaccessible.
    - 9.a. L'Administrateur ne peut pas consulter le document.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération de la liste des documents**
    ...
    - 6.e. Le système enregistre l'erreur technique dans ses journaux.
    - 7.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la liste des documents n'a pas pu être chargée.
...
- **Points à considérer pour la suite :**
  ...
  - L'Administrateur peut-il ajouter des notes ou des commentaires aux documents ?
...
- **Scénario principal :**
  ...
  6.  Le système affiche les informations de suivi de la procédure pour le Mutualiste. Ces informations sont présentées de manière simplifiée par rapport à la vue Administrateur (UC 33) et incluent au minimum :
...
- **Points à considérer pour la suite :**
  ...
  - Y a-t-il une messagerie dédiée ou un moyen de communication direct avec l'administrateur gérant la liquidation depuis cette interface ? (Liaison potentielle avec UC 40 - Messagerie Interne).
...
- **Module :** 11 - Gestion des Prestations & Contrats
- **Acteur principal :** Administrateur (ayant les droits de configuration)

- **Description :** Permet à un administrateur de créer, consulter, modifier, activer ou désactiver les définitions des différents types de prestations (les services couverts par la mutuelle) et les modèles de contrats d'adhésion, ainsi que les règles financières et d'éligibilité qui y sont associées (ex: taux de remboursement, plafonds, conditions d'accès).

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits de configuration nécessaires pour gérer les prestations et les contrats.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de configuration ou de gestion des prestations et contrats.
  ...
  - **Sous-Scénario Principal A : Créer un nouveau type de prestation ou modèle de contrat**
    ...
    - 3a. L'Administrateur clique sur l'option "Créer un type de prestation" ou "Créer un modèle de contrat".
    - 4a. Le système affiche un formulaire de saisie spécifique pour le type d'élément choisi (prestation ou contrat).
    - 5a. L'Administrateur saisit les informations de base de l'élément (ex: Nom/Libellé unique, Description détaillée, Type de prestation si applicable (ex: Soin médical, Funéraire, Éducation)).
    - 6a. L'Administrateur définit les règles et paramètres associés à cet élément :
    ...
    - 7a. L'Administrateur définit un statut initial (ex: "Actif", "Inactif", "Brouillon").
    - 8a. L'Administrateur vérifie les informations et règles configurées.
    - 9a. L'Administrateur clique sur le bouton "Enregistrer" ou "Créer".
    ...
    - 13a. Le système affiche un message de confirmation à l'Administrateur et met à jour la liste affichée.

  - **Sous-Scénario Principal M : Visualiser / Modifier un type de prestation ou modèle de contrat existant**

    - 3m. L'Administrateur sélectionne un type de prestation ou modèle de contrat dans la liste (clique sur son nom ou un bouton "Visualiser/Modifier").
    ...
    - 5m. L'Administrateur visualise les informations et peut modifier les champs autorisés (certains champs clés comme le Libellé ou Type pourraient être non modifiables une fois créés).
    - 6m. L'Administrateur peut mettre à jour les règles et paramètres associés.
    - 7m. L'Administrateur peut changer le statut (ex: passer de Actif à Inactif, ou Inactif à Actif).
    - 8m. L'Administrateur vérifie les modifications apportées.
    - 9m. L'Administrateur clique sur le bouton "Enregistrer les modifications".
  ...
  - **Sous-Scénario Principal S : Activer / Désactiver rapidement depuis la liste**
    - 3s. Dans la liste, l'Administrateur clique sur une action rapide "Activer" ou "Désactiver" associée à un élément.
    - 4s. Le système peut demander une confirmation de l'action.
    - 5s. L'Administrateur confirme.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'opération**
    ...
    - L'Administrateur annule l'action. Le système abandonne l'opération en cours.
  ...
  - **Scénario Alternatif A2 : Données ou règles invalides (Créer ou Modifier)**
    ...
    - La validation des données ou des règles échoue. Le système affiche des messages d'erreur spécifiques à côté des champs ou règles concernés. L'Administrateur reste sur le formulaire pour corriger.
  ...
  - **Scénario Alternatif A4 : Création d'un élément avec un identifiant (Nom/Code) existant**
    ...
    - Le système affiche un message d'erreur indiquant que l'identifiant est déjà utilisé et demande à l'Administrateur d'en choisir un autre.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement ou la mise à jour**
    ...
    - Le système enregistre l'erreur technique. Le système affiche un message générique d'échec à l'Administrateur. La configuration n'est pas enregistrée ou mise à jour.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des adhérents (Module 2) ou une section spécifique pour la gestion des contrats adhérents.
  2.  L'Administrateur recherche ou sélectionne le mutualiste auquel il souhaite associer un contrat.
  ...
  5.  L'Administrateur sélectionne l'option pour associer un nouveau contrat (ou modifier le contrat existant/précédent).
  6.  Le système affiche une liste des modèles de contrats disponibles et actifs (gérés via UC 36).
  7.  L'Administrateur choisit le modèle de contrat à associer au mutualiste.
  8.  L'Administrateur spécifie potentiellement la date de début de validité de ce contrat pour ce mutualiste (si différente de la date du jour).
  9.  L'Administrateur vérifie l'association et clique sur un bouton "Enregistrer" ou "Associer le contrat".
  ...
  14. Le système affiche un message de confirmation à l'Administrateur.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation par l'Administrateur**
    ...
    - ... (Étapes 1 à 9 du scénario principal)
    - 10.a. L'Administrateur décide d'annuler l'opération.
    - 11.a. L'Administrateur clique sur "Annuler".
  ...
  - **Scénario Alternatif A2 : Modèle de contrat sélectionné introuvable ou inactif**
    ...
    - 9.a. Le système affiche un message d'erreur à l'Administrateur. L'association échoue.
  ...
  - **Scénario Alternatif A4 : Le mutualiste a déjà un contrat actif (si les règles l'interdisent ou nécessitent un workflow)**
    ...
    - 12.a. Le système affiche un message d'avertissement ou d'erreur (ex: "Le mutualiste a déjà un contrat actif. Voulez-vous résilier l'ancien à partir du [Date] ?"). L'association peut être bloquée ou nécessiter une action supplémentaire de l'Administrateur.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement de l'association**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que l'association a échoué.
  ...
  - **Scénario d'Exception E3 : Échec de la mise à jour des cotisations ou de l'envoi notification**
    ...
    - 18.e. Le système enregistre l'échec. L'association du contrat est faite, mais l'Administrateur est averti du problème dans les étapes post-enregistrement, nécessitant potentiellement une action manuelle (ex: recalculer les cotisations, envoyer la notification manuellement).
...
- **Description :** Permet à un administrateur d'officialiser et d'enregistrer dans le système le prêt d'un matériel spécifique (ex: équipement médical, autre bien) de l'inventaire de la mutuelle à un mutualiste, en documentant les termes du prêt (qui, quoi, quand, retour prévu).

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour gérer les prêts et l'inventaire du matériel.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des prêts de matériel (ou la gestion de l'inventaire matériel avec option de prêt).
  2.  L'Administrateur clique sur l'option "Enregistrer un prêt de matériel".
  3.  Le système affiche un formulaire de saisie pour les informations du prêt de matériel.
  4.  L'Administrateur recherche et sélectionne le mutualiste qui emprunte le matériel.
  5.  L'Administrateur recherche et sélectionne le matériel spécifique à prêter dans l'inventaire (ex: en scannant un code-barres, en cherchant par nom ou référence).
  ...
  7.  L'Administrateur saisit les dates clés du prêt :
      - La date effective du prêt (date de remise du matériel, par défaut la date du jour).
      - La date de retour prévue du matériel.
  8.  (Optionnel) L'Administrateur saisit des informations supplémentaires (ex: motif du prêt, état visuel du matériel au départ, montant d'une éventuelle caution).
  9.  L'Administrateur vérifie les informations saisies.
  10. L'Administrateur clique sur un bouton "Enregistrer le prêt".
  ...
  15. Le système affiche un message de confirmation à l'Administrateur (ex: "Prêt de matériel enregistré avec succès. Le statut de [Nom Matériel] a été mis à jour.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées**
    ...
    - 13.a. Le système affiche des messages d'erreur. L'Administrateur reste sur le formulaire pour corriger.
  ...
  - **Scénario Alternatif A3 : Matériel sélectionné introuvable ou indisponible pour le prêt**
    ...
    - 8.a. Le système affiche un message d'erreur à l'Administrateur expliquant la raison (ex: "Ce matériel est déjà prêté jusqu'au [Date de retour prévue]"). L'opération est stoppée.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement du prêt ou de la mise à jour du statut matériel**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que l'enregistrement du prêt a échoué.

  - **Scénario d'Exception E3 : Échec de l'envoi de la notification au mutualiste**
    - ... (Étapes 1 à 16 du scénario principal)
    - 17.e. Le système rencontre une erreur lors de la tentative d'envoi de la notification au mutualiste.
    - 18.e. Le système enregistre l'échec. Le prêt est enregistré, mais l'Administrateur est averti que la notification n'a pas pu être envoyée.
...
- **Description :** Permet à un administrateur de consulter une liste récapitulative de tous les matériels appartenant à la mutuelle qui sont actuellement prêtés à des mutualistes. Cette liste affiche les informations essentielles de chaque prêt en cours pour faciliter le suivi de l'inventaire et des retours attendus.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour consulter les informations relatives aux prêts de matériel.
  - Le système contient des enregistrements de prêts de matériel ayant un statut "Prêté" ou équivalent.

- **Postconditions :**

  - L'administrateur a consulté la liste des matériels actuellement prêtés. Aucune modification de données n'est effectuée par ce cas d'utilisation.
  - La liste des prêts de matériel actifs est affichée à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des prêts de matériel ou d'inventaire.
  2.  L'Administrateur accède à la vue ou au rapport affichant la liste des matériels actuellement prêtés (ex: un onglet "Matériels prêtés", un rapport sur le tableau de bord (UC 51), ou un filtre appliqué à la liste générale de l'inventaire).
  ...
  5.  L'Administrateur consulte la liste affichée pour visualiser l'état des prêts en cours.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération de la liste des prêts actifs**
    ...
    - 5.e. Le système enregistre l'erreur technique dans ses journaux.
    - 6.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la liste des prêts actifs n'a pas pu être chargée pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - En cliquant sur un élément de la liste, l'Administrateur peut-il accéder directement à l'enregistrement de prêt spécifique (potentiellement pour marquer son retour - UC "Enregistrer retour matériel") ou au dossier du mutualiste emprunteur ?
...
- **Postconditions :**
  ...
  - La réclamation est signalée aux administrateurs concernés pour traitement (ex: ajout à une liste de tâches, notification interne).
...
- **Scénario principal :**
  ...
  19. Le système notifie les administrateurs responsables des réclamations qu'une nouvelle réclamation a été soumise, potentiellement en l'ajoutant à une liste de tâches ou à un rapport sur le tableau de bord Admin (UC 51).
...
- **Points à considérer pour la suite :**
  - Comment le système gère-t-il le _workflow_ de traitement de la réclamation par les administrateurs après la soumission ? (Nécessiterait des UC Admin comme "Traiter une réclamation", "Mettre à jour statut réclamation", "Répondre à une réclamation").
...
- **Module :** 13 - Gestion des Réclamations & Litiges
- **Acteur principal :** Administrateur (Gestionnaire Réclamations ou tout Admin désigné)

- **Description :** Permet à un administrateur de prendre en charge, d'analyser, de mettre à jour le statut, d'ajouter des commentaires internes et de gérer globalement le processus de résolution d'une réclamation soumise par un mutualiste (UC 42).

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder et traiter les réclamations.
  ...
  - L'administrateur a accès à l'interface listant les réclamations à traiter.

- **Postconditions :**

  - Le statut de la réclamation est mis à jour pour refléter l'avancement de son traitement.
  - Des notes internes sont ajoutées à la réclamation par l'administrateur.
  - La réclamation peut être assignée à un administrateur spécifique.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section de gestion des réclamations (ou accède à la liste des réclamations sur son tableau de bord UC 51).
  ...
  3.  L'Administrateur sélectionne une réclamation spécifique dans la liste pour commencer son traitement (clique sur la référence, le mutualiste, ou un bouton "Traiter").
  ...
  5.  L'Administrateur examine attentivement les informations fournies par le mutualiste et visualise les documents joints.
  6.  L'Administrateur effectue les actions nécessaires pour traiter la réclamation :
      ...
      - **Assignation :** S'assigne la réclamation ou la réassigne à un autre administrateur ou service si nécessaire.
      - **Ajout de notes internes :** Saisit des commentaires, résumés d'investigation, décisions internes, ou actions effectuées (visibles uniquement par les administrateurs).
  ...
  7.  L'Administrateur enregistre les modifications et actions effectuées (clique sur un bouton "Enregistrer", "Mettre à jour le statut et ajouter note").
  8.  Le système valide les données soumises (nouveau statut valide, notes non vides si obligatoires, assignation valide).
  9.  Si les validations réussissent, le système met à jour l'enregistrement de la réclamation avec le nouveau statut, l'assignation et les notes internes. 10. Le système enregistre un événement dans l'historique de traitement de la réclamation (qui, quand, quel changement de statut, notes ajoutées, réassignation). 11. Le système affiche un message de confirmation à l'Administrateur indiquant que la réclamation a été mise à jour. 12. (Optionnel) Si le changement de statut est configuré pour notifier le mutualiste (ex: passage à "En cours", "Résolue", "Refusée"), le système déclenche l'envoi d'une notification (via messagerie interne UC 40 / UC 50 ou email).

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation des modifications par l'Administrateur**

    - ... (Étapes 1 à 7 du scénario principal)
    - 8.a. L'Administrateur décide de ne pas enregistrer les modifications en cours.
    - 9.a. L'Administrateur clique sur un bouton "Annuler" ou quitte la page sans sauvegarder.
    - 10.a. Le système abandonne les modifications.

  - **Scénario Alternatif A2 : Réclamation sélectionnée déjà traitée/mise à jour par un autre Administrateur**

    - ... (Étapes 1 à 3 du scénario principal)
    - 4.a. L'Administrateur sélectionne une réclamation, mais le système détecte qu'elle a été modifiée (statut, notes, assignation) par un autre administrateur depuis l'affichage de la liste.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement des modifications ou de l'historique**
    ...
    - 13.e. Le système affiche un message d'erreur générique à l'Administrateur. Les modifications peuvent ne pas être enregistrées.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification automatique au mutualiste (si déclenchée)**
    ...
    - 14.e. Le système enregistre l'échec de la notification. Le statut de la réclamation est bien mis à jour, mais l'Administrateur est averti que la notification n'a pas pu être envoyée.
...
- **Points à considérer pour la suite :**
  ...
  - Comment les administrateurs peuvent-ils communiquer _avec le mutualiste_ dans le cadre de cette réclamation (réponse formelle, demande d'infos) ? Est-ce via un système de messagerie intégré (lien avec UC 40/50) ou un autre moyen ?
...
- **Points à considérer pour la suite :**
  - Quelles informations (statuts, actions administratives) sont rendues visibles au mutualiste dans l'historique de traitement (étape 7) ? Faut-il masquer certaines notes internes de l'administrateur ?
...
- **Points à considérer pour la suite :**
  - Quels types de documents ajoutés par l'Administrateur sont visibles par le Mutualiste ? (ex: uniquement les courriers officiels de réponse, pas les notes internes).
...
- **Préconditions :**
  ...
  - Le mutualiste est authentifié et connecté à son espace personnel (UC 1 réussi).
  - Le système de messagerie interne est activé et accessible pour les mutualistes et les administrateurs.
...
- **Postconditions :**
  ...
  - Une notification est envoyée aux administrateurs concernés par le nouveau message.
...
- **Scénario principal :**
  ...
  17. Le système déclenche une notification automatique pour les administrateurs concernés les informant qu'un nouveau message a été reçu dans leur boîte de réception (UC 48 implicite).
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario d'Exception E2 : Échec de la notification automatique des Administrateurs**
    - ... (Étapes 1 à 17 du scénario principal)
    - 18.e. Le système tente d'envoyer une notification aux administrateurs (via alerte interne, email) signalant la réception d'un nouveau message, mais l'envoi de cette notification échoue.
    - 19.e. Le système enregistre l'échec de la notification. Le message est bien enregistré et acheminé dans la messagerie interne, mais les Administrateurs ne sont pas alertés automatiquement.

- **Points à considérer pour la suite :**
  - Comment l'acheminement du message vers les bons administrateurs ou services est-il géré (règles basées sur le destinataire choisi, le type de message, le mutualiste) ?
...
- **Module :** 14 - Gestion de la Messagerie Interne
- **Acteur principal :** Administrateur (ayant accès à la messagerie interne)

- **Description :** Permet à un administrateur de rédiger et d'envoyer une réponse à un message reçu d'un mutualiste via le système de messagerie interne. Cette réponse est intégrée au fil de conversation existant, permettant un suivi chronologique des échanges.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et possède les droits nécessaires pour accéder à la messagerie interne et y répondre.
  ...
  - L'administrateur a accédé à l'interface de messagerie (UC 48 implicite) et a sélectionné la conversation ou le message auquel il souhaite répondre.

- **Postconditions :**

  - Un nouveau message de réponse est créé, contenant le texte rédigé par l'administrateur.
  - Ce message est ajouté au fil de conversation existant avec le mutualiste et enregistré dans la base de données.
  - Le message est marqué comme envoyé par l'administrateur et destiné au mutualiste.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section "Messagerie Interne".
  2.  Le système affiche la liste des conversations ou messages (reçus, envoyés, en cours) auxquels l'Administrateur a accès (UC 48 implicite).
  3.  L'Administrateur sélectionne une conversation avec un mutualiste (clique sur la conversation) pour visualiser le fil des échanges.
  ...
  5.  L'Administrateur clique sur l'option "Répondre" (si non affichée par défaut) et rédige le corps de sa réponse dans la zone de saisie prévue.
  6.  (Optionnel) L'Administrateur peut joindre un document pertinent à sa réponse (ex: une lettre officielle, un justificatif, un document informatif) si la fonctionnalité est activée.
  7.  L'Administrateur vérifie le contenu de sa réponse et les éventuelles pièces jointes.
  8.  L'Administrateur clique sur un bouton "Envoyer" ou "Envoyer la réponse".
  ...
  11. Ce nouveau message est associé au fil de conversation sélectionné et marqué comme envoyé par l'administrateur actuel et destiné au mutualiste participant à la conversation.
  ...
  15. Le système affiche un message de confirmation à l'Administrateur (ex: "Réponse envoyée avec succès.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'envoi de la réponse**
    ...
    - ... (Étapes 1 à 8 du scénario principal)
    - 9.a. L'Administrateur décide de ne pas envoyer la réponse.
    - 10.a. L'Administrateur clique sur "Annuler" ou quitte la zone de saisie.
  ...
  - **Scénario Alternatif A2 : Corps du message de réponse vide**
    ...
    - 11.a. Le système affiche un message d'erreur (ex: "Vous ne pouvez pas envoyer un message vide"). L'Administrateur reste sur la zone de saisie pour ajouter du contenu.
  ...
  - **Scénario d'Exception E1 : Conversation/Message introuvable ou non accessible**
    ...
    - ... (Étapes 1 à 3 du scénario principal)
    - 4.e. Le système ne trouve pas la conversation ou le message spécifique auquel l'Administrateur tente de répondre (ex: la conversation a été archivée ou supprimée par un autre administrateur juste avant, ou il y a une erreur technique).
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement ou de l'association au fil de conversation**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur (ex: "Une erreur s'est produite lors de l'envoi de votre réponse. Veuillez réessayer."). La réponse n'est pas envoyée.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification automatique au Mutualiste**
    ...
    - 16.e. Le système enregistre l'échec de la notification. La réponse est bien envoyée et enregistrée dans la conversation, mais le Mutualiste n'est pas alerté automatiquement. L'Administrateur est généralement informé de cet échec.

- **Points à considérer pour la suite :**
  - Comment le fil de conversation est-il visualisé (affichage imbriqué, simple liste chronologique) ?
  - Comment l'Administrateur distingue-t-il les messages "lus" des messages "non lus" (UC 48) ?
  - Le système permet-il aux administrateurs d'initier une nouvelle conversation avec un mutualiste, sans attendre que le mutualiste envoie le premier message (nécessiterait un UC "Envoyer un message à un mutualiste (Admin)") ?
  - Des règles de sécurité et de confidentialité s'appliquent-elles (ex: certains administrateurs ne peuvent voir/répondre qu'à certains types de messages ou de mutualistes) ?
...
- **Description :** Permet à un administrateur de consulter l'interface de la messagerie interne pour voir la liste des conversations ou messages qu'il a reçus des mutualistes (ou potentiellement d'autres administrateurs) et d'ouvrir des conversations spécifiques pour lire l'intégralité des échanges.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder à la section de messagerie interne.
  - Le système de messagerie interne contient des messages ou des conversations enregistrés et accessibles à cet administrateur.

- **Postconditions :**

  - L'administrateur a pu consulter la liste des conversations/messages.
  - L'administrateur a pu ouvrir et lire les messages contenus dans un fil de conversation spécifique.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section "Messagerie Interne".
  2.  Le système affiche l'interface principale de la messagerie pour l'Administrateur. Cette interface présente une liste des conversations ou messages récents, généralement dans un panneau latéral ou une zone dédiée.
  ...
  4.  L'Administrateur consulte la liste des conversations ou messages. Des options de tri ou de filtrage (ex: messages non lus, par mutualiste, par sujet) peuvent être disponibles.
  5.  L'Administrateur sélectionne une conversation spécifique dans la liste (clique sur la conversation ou le message).
  6.  Le système récupère tous les messages qui composent le fil de conversation sélectionné.
  7.  Le système affiche le fil de conversation complet. Chaque message est affiché avec son contenu, l'expéditeur (le mutualiste ou l'administrateur qui a envoyé le message), et la date/heure d'envoi. Le fil est généralement affiché dans l'ordre chronologique.
  8.  (Optionnel) Le système marque automatiquement comme "lus" les messages de cette conversation qui étaient précédemment non lus pour cet administrateur.
  9.  L'Administrateur lit les messages contenus dans le fil de conversation. Il peut ensuite décider d'y répondre (UC 47).

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Aucune conversation ou message accessible à l'Administrateur**

    - ... (Étapes 1 à 2 du scénario principal)
    - 3.a. Le système interroge la base de données mais ne trouve aucune conversation ou message que cet Administrateur a le droit de voir (basé sur les règles d'accès ou d'assignation).
  ...
  - **Scénario Alternatif A2 : Conversation ou message sélectionné introuvable ou non accessible**
    ...
    - ... (Étapes 1 à 4 du scénario principal)
    - 5.a. L'Administrateur sélectionne une conversation, mais le système ne la trouve pas (ex: elle a été supprimée ou archivée par un autre administrateur juste avant) ou l'Administrateur n'a pas les droits d'y accéder.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération de la liste des conversations ou des messages d'une conversation**
    ...
    - 5.e. / 8.e. Le système enregistre l'erreur technique dans ses journaux.
    - 6.e. / 9.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la messagerie n'a pas pu être chargée pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - L'Administrateur peut-il rechercher dans le contenu des messages ou dans les objets ?
  - Des options d'archivage ou de suppression de conversations sont-elles disponibles pour les Administrateurs ?
  - Comment les règles d'accès et d'acheminement des messages sont-elles définies pour s'assurer que les bons administrateurs voient les bons messages ? (Liaison avec les droits des utilisateurs et potentiellement la configuration des services).
  - L'Administrateur peut-il filtrer par mutualiste pour voir tous les messages échangés avec cet adhérent spécifique ?
...
- **Description :** Permet à un administrateur d'initier une nouvelle conversation ou d'envoyer un message non sollicité à un mutualiste spécifique via le système de messagerie interne sécurisé, par exemple pour lui communiquer une information importante, lui demander des précisions, ou l'informer d'une mise à jour le concernant.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour envoyer des messages aux mutualistes.
  ...
  - L'administrateur a une information ou une communication qu'il souhaite envoyer au mutualiste.
...
- **Postconditions :**
  ...
  - Le message est créé et enregistré dans le système, associé à l'administrateur expéditeur et au mutualiste destinataire.
  - Un enregistrement d'audit est créé pour l'envoi du message par l'administrateur.
  - Une notification automatique est envoyée au mutualiste destinataire pour l'informer d'un nouveau message (UC 50 implicite).
  - (Optionnel) Une confirmation d'envoi est affichée à l'Administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration et navigue vers la section "Messagerie Interne" (UC 48 implicite).
  2.  L'Administrateur clique sur l'option "Nouveau Message", "Envoyer un message à un mutualiste", ou similaire.
  3.  Le système affiche un formulaire de composition de message.
  4.  L'Administrateur recherche et sélectionne le mutualiste destinataire du message. Le système peut afficher une confirmation de l'éligibilité du mutualiste à recevoir des messages internes.
  5.  L'Administrateur saisit l'objet de son message.
  6.  L'Administrateur rédige le corps du message qu'il souhaite envoyer au mutualiste.
  7.  (Optionnel) L'Administrateur peut joindre des documents pertinents si la fonctionnalité est disponible et configurée (ex: document informatif, accusé de réception).
  8.  L'Administrateur vérifie le contenu, l'objet et le destinataire de son message.
  9.  L'Administrateur clique sur un bouton "Envoyer".
  ...
  12. Le message est associé à l'Administrateur expéditeur et au Mutualiste destinataire. Si une conversation existe déjà avec ce mutualiste sur ce sujet ou un sujet similaire, le message peut être ajouté à ce fil ; sinon, une nouvelle conversation est initiée.
  ...
  16. Le système affiche un message de confirmation à l'Administrateur (ex: "Message envoyé à [Nom du Mutualiste] avec succès.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'envoi par l'Administrateur**
    ...
    - ... (Étapes 1 à 9 du scénario principal)
    - 10.a. L'Administrateur décide de ne pas envoyer le message.
    - 11.a. L'Administrateur clique sur "Annuler", "Fermer", ou quitte le formulaire sans sauvegarder.
  ...
  - **Scénario Alternatif A2 : Mutualiste destinataire introuvable ou incapable de recevoir des messages**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur recherche ou sélectionne un mutualiste, mais le système ne le trouve pas, ou vérifie que son statut actuel (ex: compte fermé, messagerie désactivée) ne permet pas de recevoir des messages internes.
    - 7.a. Le système affiche un message d'erreur à l'Administrateur (ex: "Mutualiste introuvable" ou "Ce mutualiste ne peut pas recevoir de messages internes pour le moment"). L'envoi n'est pas possible.
  ...
  - **Scénario Alternatif A3 : Données manquantes ou invalides détectées**
    ...
    - 12.a. Le système affiche des messages d'erreur. L'Administrateur reste sur le formulaire pour corriger.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'enregistrement ou de l'envoi du message**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur (ex: "Une erreur s'est produite lors de l'envoi du message."). L'opération échoue.
  ...
  - **Scénario d'Exception E2 : Échec de l'envoi de la notification automatique au Mutualiste**
    ...
    - 17.e. Le système enregistre l'échec de la notification. Le message est bien enregistré et envoyé, mais le Mutualiste n'est pas alerté automatiquement. L'Administrateur est généralement informé de cet échec.

- **Points à considérer pour la suite :**
  - Les administrateurs peuvent-ils envoyer des messages à plusieurs mutualistes à la fois (ex: pour des communications générales, des alertes) ? (Ce serait un UC distinct comme "Envoyer un message groupé aux mutualistes").
  - Les administrateurs peuvent-ils utiliser des modèles de messages prédéfinis pour les communications fréquentes ?
  - Comment les messages initiés par l'Admin sont-ils classés ou affichés dans la messagerie du Mutualiste (UC 50) ?
  - Existe-t-il une politique de conservation des messages envoyés/reçus par les administrateurs ?
...
- **Scénario principal :**
  ...
  8.  Le système affiche le fil de conversation complet dans l'ordre chronologique. Chaque message est affiché avec son contenu, l'expéditeur (indiqué comme "Moi" pour les messages envoyés par le Mutualiste, "Administration" ou le nom du service/administrateur pour les messages reçus), et la date/heure d'envoi.
...
- **Description :** Permet à un administrateur d'accéder à un écran de synthèse présentant les principaux indicateurs de performance (KPI), des statistiques clés, des résumés d'activité et des alertes du système, pour offrir une vue d'ensemble rapide et faciliter le monitoring et la gestion quotidienne de la mutuelle.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits d'accès au tableau de bord administratif.
...
- **Postconditions :**
  ...
  - L'administrateur a consulté les informations présentées sur le tableau de bord. Aucune modification des données sous-jacentes n'est effectuée par cette consultation.
  - Le tableau de bord administratif est affiché à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration (authentification gérée par UC 1).
  2.  Immédiatement après l'authentification ou en naviguant vers la page d'accueil ou une section dédiée, l'Administrateur accède au tableau de bord.
  3.  Le système identifie l'Administrateur et ses droits pour déterminer les informations et les widgets qu'il peut voir.
  ...
  5.  Le système organise et affiche les informations sous forme de différents widgets sur la page du tableau de bord. Ces widgets peuvent inclure (basé sur les exigences et les modules détaillés) :
      ...
      - Tâches en attente assignées à l'Administrateur.
  6.  L'Administrateur consulte les différents indicateurs et résumés pour avoir une vue d'ensemble de l'état de la mutuelle.
  7.  (Optionnel) L'Administrateur peut cliquer sur certains éléments (ex: une ligne dans une liste de réclamations, une barre dans un graphique de prestations) pour accéder à la page de gestion détaillée correspondante dans un autre module (ex: accéder à UC 43 pour traiter une réclamation).
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucune donnée disponible pour certains indicateurs**
    ...
    - 7.a. L'Administrateur prend connaissance de l'information.
...
- **Points à considérer pour la suite :**
  ...
  - Le tableau de bord est-il personnalisable par l'Administrateur (choix des widgets, de la disposition) ?
...
**UC 53 - Gérer les comptes administrateurs**

- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Super Administrateur (ou Administrateur système ayant les droits de gestion des utilisateurs Admin)

- **Description :** Permet à un Super Administrateur de superviser et de gérer les comptes d'accès des autres administrateurs du système. Cela inclut la création de nouveaux comptes, la modification des informations et des permissions, l'activation ou la désactivation des accès.

- **Préconditions :**

  - Le Super Administrateur est authentifié dans le système avec un compte disposant des droits nécessaires pour gérer les comptes administrateurs.
  - L'interface d'administration pour la gestion des utilisateurs est accessible.
  - (Pour modification/visualisation) Le compte administrateur spécifique à gérer existe déjà dans le système.

- **Postconditions :**

  - Un compte administrateur est créé, mis à jour, activé, désactivé ou supprimé dans le système.
  - Les informations (identifiant, rôles, statut) du compte géré sont enregistrées ou modifiées.
  - Un enregistrement d'audit détaillé est créé pour l'action de gestion effectuée sur le compte administrateur (qui a fait quoi, sur quel compte, quand).
  - (Optionnel) Le nouvel administrateur est notifié de la création de son compte, ou l'administrateur concerné est notifié d'un changement majeur (ex: désactivation).

- **Scénario principal (Combinant Création, Consultation, Modification, Gestion du statut) :**

  1.  Le Super Administrateur se connecte à l'interface d'administration (UC 1 implicite).
  2.  Le Super Administrateur navigue vers la section de gestion des utilisateurs ou des comptes administrateurs (souvent via un menu "Administration" ou "Paramètres Système").
  3.  Le système affiche la liste de tous les comptes administrateurs existants. Pour chaque compte, des informations clés sont présentées (ex: Nom/Prénom, Identifiant de connexion, Rôle(s) assigné(s), Statut (Actif/Inactif/Bloqué), Date de création, Dernière connexion). Des options pour agir sur chaque compte (Visualiser, Modifier, Activer/Désactiver, Réinitialiser mot de passe, Supprimer si applicable) et une option pour créer un nouveau compte sont disponibles.

  - **Sous-Scénario Principal A : Créer un nouveau compte administrateur**

    - 4a. Le Super Administrateur clique sur l'option "Créer un compte administrateur".
    - 5a. Le système affiche un formulaire de création de compte.
    - 6a. Le Super Administrateur saisit les informations obligatoires du nouvel administrateur (ex: Nom, Prénom, Adresse Email, Identifiant de connexion unique, Numéro de téléphone).
    - 7a. Le Super Administrateur attribue les rôles et permissions nécessaires au nouvel administrateur en sélectionnant un ou plusieurs rôles prédéfinis (ex: "Gestionnaire Cotisations", "Superviseur Prêts", "Gestionnaire Réclamations") ou en définissant des permissions spécifiques si le système le permet.
    - 8a. Le système peut automatiquement générer un mot de passe temporaire sécurisé ou permettre au Super Administrateur de le définir initialement. Le système peut aussi exiger que le nouvel admin change son mot de passe à la première connexion.
    - 9a. Le Super Administrateur définit le statut initial du compte (généralement "Actif").
    - 10a. Le Super Administrateur vérifie les informations et rôles attribués.
    - 11a. Le Super Administrateur clique sur le bouton "Enregistrer", "Créer le compte", ou similaire.
    ...
    - 13a. Si les validations réussissent, le système crée le nouvel enregistrement de compte administrateur avec les informations fournies, les rôles/permissions, le mot de passe initial et le statut.
    - 14a. Le système enregistre l'historique de la création de ce compte d'utilisateur.
    - 15a. Le système affiche un message de confirmation (ex: "Compte administrateur créé pour [Identifiant]. Un mot de passe temporaire a été envoyé par email."). La liste des comptes est mise à jour.
    - 16a. (Optionnel) Le système envoie une notification (par email ou SMS) au nouvel administrateur avec ses informations de connexion initiales et les instructions pour sa première connexion.

  - **Sous-Scénario Principal M : Visualiser / Modifier / Gérer un compte administrateur existant**

    - 4m. Le Super Administrateur sélectionne un compte administrateur dans la liste (clique sur le nom, un bouton "Modifier" ou "Gérer").
    ...
    - 6m. Le Super Administrateur visualise les informations. Il peut modifier les champs autorisés (ex: Nom, Prénom, Email, Numéro de téléphone).
    - 7m. Le Super Administrateur peut modifier les rôles et permissions associés au compte, ou changer son statut (Actif/Inactif/Bloqué).
    - 8m. Le Super Administrateur peut également effectuer des actions spécifiques sur le compte via des options dédiées (ex: cliquer sur "Réinitialiser le mot de passe" pour générer un nouveau mot de passe temporaire, "Déverrouiller le compte" si le compte a été bloqué suite à trop de tentatives de connexion infructueuses).
    - 9m. Le Super Administrateur vérifie les modifications ou l'action sélectionnée.
    - 10m. Le Super Administrateur clique sur le bouton "Enregistrer les modifications" ou confirme l'action spécifique (ex: "Confirmer Réinitialisation Mot de Passe").
    ...
    - 15m. (Optionnel) Si l'action est sensible (ex: réinitialisation de mot de passe, désactivation), le système peut notifier l'administrateur dont le compte a été modifié.

  - **Sous-Scénario Principal S : Activer / Désactiver rapidement depuis la liste**
    - 4s. Dans la liste des comptes administrateurs (étape 3), le Super Administrateur clique sur l'action rapide "Activer" ou "Désactiver" associée à un compte spécifique.
    - 5s. Le système peut demander une confirmation de l'action ("Êtes-vous sûr de vouloir désactiver ce compte ?").
    - 6s. Le Super Administrateur confirme l'action.
    ...
    - 8s. Si l'action est permise, le système met à jour le statut du compte administrateur dans la base de données (passe de Actif à Inactif, ou inversement).
    - 9s. Le système enregistre l'historique du changement de statut rapide.
    - 10s. Le système affiche un message de confirmation (ex: "Compte [Nom] désactivé avec succès."). La liste est mise à jour.
    - 11s. (Optionnel) Le système peut envoyer une notification à l'administrateur concerné pour l'informer que son compte a été désactivé.

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation de l'opération**

    - Applicable à chaque sous-scénario avant la validation finale. Le Super Administrateur annule l'action en cours. Le système abandonne le processus.
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides (Créer ou Modifier)**
    ...
    - Le système affiche des messages d'erreur précis à côté des champs concernés. Le Super Administrateur reste sur le formulaire pour apporter les corrections nécessaires.
  ...
  - **Scénario Alternatif A3 : Tentative d'action non permise sur un compte critique ou sur son propre compte**
    ...
    - Le système détecte que l'action demandée par le Super Administrateur n'est pas autorisée pour des raisons de sécurité ou de cohérence du système (ex: tenter de désactiver le compte du Super Administrateur actuellement connecté, tenter de supprimer le dernier compte Super Admin actif, tenter de modifier ses propres permissions critiques).
    - Le système bloque l'action et affiche un message d'erreur expliquant pourquoi l'opération n'est pas permise.

  - **Scénario d'Exception E1 : Compte administrateur introuvable (Visualiser, Modifier, Gérer, Statut rapide)**

    - Applicable aux sous-scénarios M (étape 4m) et S (étape 4s).
    - Le compte administrateur sélectionné ou recherché n'est pas trouvé dans le système (ex: a été supprimé par un autre Super Admin juste avant).
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement, la mise à jour ou l'action sur le compte**
    ...
    - Une erreur technique imprévue se produit lors de la tentative de sauvegarder les informations du compte administrateur, de le mettre à jour, ou d'exécuter une action (ex: réinitialisation de mot de passe en base de données).
    - Le système enregistre l'erreur technique dans ses logs.
    - Le système affiche un message d'erreur générique à l'Administrateur (ex: "Une erreur système s'est produite lors de l'enregistrement du compte."). L'opération échoue.
  ...
  - **Scénario d'Exception E3 : Échec de l'envoi de la notification automatique (création, reset mdp, désactivation)**
    ...
    - Le système tente d'envoyer une notification par email ou un autre canal de communication à l'administrateur concerné, mais l'envoi échoue (ex: problème de configuration email, adresse invalide).
    - Le système enregistre l'échec de la notification. L'action sur le compte (création, modification, réinitialisation, statut) est bien effectuée, mais le Super Administrateur est averti que la notification n'a pas été envoyée.
...
- **Points à considérer pour la suite :**
  ...
  - Le système gère-t-il l'authentification à plusieurs facteurs (MFA) pour les comptes administrateurs ?
  - L'historique des connexions et des actions effectuées par chaque administrateur est-il tracé et consultable ? (UC 54).
  - Un processus de "suppression logique" (désactivation permanente) vs "suppression physique" est-il nécessaire pour les comptes administrateurs ?
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Super Administrateur (ou Administrateur de l'audit)

- **Description :** Permet à un super administrateur d'accéder et de consulter les enregistrements détaillés de toutes les actions significatives effectuées par les utilisateurs (administrateurs et potentiellement mutualistes pour certaines actions sensibles) dans le système. Cet historique est essentiel pour l'audit, la détection d d'activités suspectes et le suivi précis des opérations.

- **Préconditions :**

  - Le Super Administrateur est authentifié dans le système avec un compte disposant des droits nécessaires pour consulter les logs d'activité système.
...
- **Postconditions :**
  ...
  - Le Super Administrateur a pu consulter la liste des logs d'activité, potentiellement en utilisant des filtres ou une recherche. Aucune modification des logs n'est effectuée par cette consultation.
  - L'historique des actions (logs d'activité) est affiché à l'écran du Super Administrateur.

- **Scénario principal :**

  1.  Le Super Administrateur se connecte à l'interface d'administration (UC 1 implicite).
  2.  Le Super Administrateur navigue vers la section dédiée à l'audit, aux journaux système, ou aux logs d'activité.
  ...
  4.  Le Super Administrateur utilise les options de filtrage et de recherche disponibles pour affiner les logs affichés (ex: filtrer par date/période, par utilisateur spécifique, par type d'action, par succès/échec, rechercher une référence spécifique de mutualiste ou de prêt).
  5.  Le système actualise la liste des logs affichés en fonction des filtres et de la recherche appliqués.
  6.  Le Super Administrateur consulte la liste filtrée et/ou recherchée des logs d'activité. La liste peut être paginée pour gérer un grand volume de données.
  7.  (Optionnel) Le Super Administrateur peut cliquer sur une entrée de log spécifique pour afficher tous les détails enregistrés pour cet événement dans une vue dédiée.
  8.  (Optionnel) Le Super Administrateur peut trier la liste des logs par différentes colonnes.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucune log enregistrée (ou correspondant aux filtres/recherche)**
    ...
    - 8.a. Le Super Administrateur prend connaissance de l'information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération ou de l'affichage des logs**
    ...
    - 9.e. Le système affiche un message d'erreur générique au Super Administrateur indiquant que les logs d'activité n'ont pas pu être chargés pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - Comment la sécurité des logs eux-mêmes est-elle garantie (empêcher la modification ou la suppression des logs par un administrateur, même Super Admin) ?
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Super Administrateur

- **Description :** Permet à un Super Administrateur de définir la structure des droits d'accès dans le système en créant, modifiant et supprimant des rôles. Pour chaque rôle, le Super Administrateur associe l'ensemble précis des permissions (actions autorisées) que les administrateurs ayant ce rôle posséderont.

- **Préconditions :**

  - Le Super Administrateur est authentifié dans le système avec un compte disposant des droits complets pour gérer les rôles et les permissions.
...
- **Scénario principal (Combinant Création, Consultation, Modification, Suppression de Rôles) :**
  ...
  1.  Le Super Administrateur se connecte à l'interface d'administration (UC 1 implicite).
  2.  Le Super Administrateur navigue vers la section de gestion des utilisateurs, puis vers la sous-section "Rôles et Permissions".
  3.  Le système affiche la liste de tous les rôles actuellement configurés dans le système. Pour chaque rôle, des informations comme le Nom du rôle, une courte Description, et potentiellement le nombre d'administrateurs actuellement assignés à ce rôle (pour aider à la gestion des dépendances) sont présentées. Des options pour "Créer un nouveau rôle", "Visualiser/Modifier", et "Supprimer" sont disponibles pour chaque rôle (selon qu'il est modifiable/supprimable).

  - **Sous-Scénario Principal A : Créer un nouveau rôle**

    - 4a. Le Super Administrateur clique sur le bouton "Créer un nouveau rôle".
    ...
    - 6a. Le Super Administrateur saisit un Nom unique pour le rôle (ex: "Gestionnaire Adhérents Senior", "Support Niveaux 1", "Comptable Principal").
    - 7a. Le Super Administrateur saisit une Description expliquant le but ou les responsabilités de ce rôle.
    ...
    - 9a. Le Super Administrateur associe les permissions souhaitées à ce rôle en les sélectionnant dans la liste (ex: en cochant des cases). Par exemple, pour un rôle "Gestionnaire Adhérents Senior", il pourrait cocher des permissions comme `mutualiste.creer`, `mutualiste.visualiser.tout`, `mutualiste.modifier.tout`, `ayantdroit.gerer.tout`, `document.mutualiste.gerer`, mais pas `parametres.systeme.gerer` ou `utilisateur.admin.gerer`.
    - 10a. Le Super Administrateur vérifie le nom, la description et l'ensemble des permissions sélectionnées pour le nouveau rôle.
    - 11a. Le Super Administrateur clique sur le bouton "Enregistrer le rôle".
  ...
  - **Sous-Scénario Principal M : Visualiser / Modifier un rôle existant**
    ...
    - 4m. Le Super Administrateur sélectionne un rôle dans la liste (clique sur son nom ou un bouton "Visualiser/Modifier").
    ...
    - 6m. Le Super Administrateur peut modifier le Nom (si autorisé) et la Description du rôle.
    - 7m. Le Super Administrateur peut ajouter ou retirer des permissions associées à ce rôle en modifiant la sélection dans la liste des permissions disponibles (ex: cocher de nouvelles permissions, décocher celles qui ne doivent plus être associées).
    - 8m. Le Super Administrateur vérifie les modifications apportées (nom, description, ensemble des permissions).
    - 9m. Le Super Administrateur clique sur le bouton "Enregistrer les modifications".
    ...
    - 11m. Si les validations réussissent, le système met à jour l'enregistrement du rôle et ses associations de permissions dans la base de données. Les administrateurs ayant ce rôle auront leurs permissions effectives mises à jour (potentiellement à leur prochaine connexion ou immédiatement selon l'implémentation technique des droits).
  ...
  - **Sous-Scénario Principal D : Supprimer un rôle (si applicable)**
    - 4d. Le Super Administrateur sélectionne un rôle dans la liste (étape 3) et clique sur l'option "Supprimer". L'option "Supprimer" peut être grisée ou absente si le rôle n'est pas supprimable (ex: rôle système, rôle assigné à des utilisateurs).
    - 5d. Si l'option "Supprimer" est disponible, le système vérifie à nouveau qu'aucun administrateur n'est actuellement assigné à ce rôle.
    - 6d. Si aucune dépendance (administrateurs assignés) n'est trouvée et si le rôle n'est pas un rôle système non supprimable, le système demande une confirmation explicite de l'action ("Êtes-vous sûr de vouloir supprimer le rôle '[Nom du rôle]' ? Cette action est irréversible et affectera les utilisateurs qui pourraient y être assignés à l'avenir.").
    - 7d. Le Super Administrateur confirme la suppression.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'opération**
    ...
    - Applicable à chaque sous-scénario avant la validation finale (étapes 11a, 9m, 7d). Le Super Administrateur annule l'action en cours. Le système abandonne le processus de création, modification ou suppression.
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides (Créer ou Modifier)**
    ...
    - Le système affiche un message d'erreur précis (ex: "Le nom du rôle est obligatoire", "Ce nom de rôle existe déjà"). L'Administrateur reste sur le formulaire pour corriger les informations.

  - **Scénario Alternatif A3 : Tentative de supprimer un rôle assigné à des administrateurs (Supprimer)**

    - Applicable au sous-scénario D (étape 5d). Le système détecte que le rôle que le Super Administrateur tente de supprimer est actuellement assigné à un ou plusieurs comptes administrateurs.
    - Le système bloque la suppression et affiche un message d'erreur (ex: "Ce rôle ne peut pas être supprimé car [X] administrateurs y sont encore assignés. Veuillez d'abord désassigner ce rôle des comptes utilisateurs."). L'Administrateur doit gérer les utilisateurs concernés (UC 53) avant de pouvoir supprimer le rôle.

  - **Scénario Alternatif A4 : Tentative de modifier ou supprimer un rôle système critique ou le rôle du Super Admin connecté**

    - Applicable aux sous-scénarios M et D. Le système détecte que le rôle est un rôle essentiel au fonctionnement du système (ex: le rôle "Super Admin" lui-même) ou est le rôle du compte Super Administrateur actuellement connecté.
  ...
  - **Scénario d'Exception E1 : Rôle introuvable (Visualiser, Modifier, Supprimer)**
    ...
    - Applicable aux sous-scénarios M (étape 4m) et D (étape 4d). Le rôle sélectionné par le Super Administrateur n'est pas trouvé dans le système (ex: a été supprimé par un autre Super Admin juste avant l'action, ou il y a une erreur interne).
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'enregistrement, la mise à jour ou la suppression du rôle/permissions**
    ...
    - Le système affiche un message d'erreur générique au Super Administrateur (ex: "Une erreur système s'est produite lors de la gestion du rôle."). L'opération échoue.
...
- **Points à considérer pour la suite :**
  ...
  - Quand les changements de permissions prennent-ils effet pour les administrateurs connectés (immédiatement ou à la prochaine connexion) ?
...
- **Description :** Permet à un Super Administrateur de configurer les paramètres de sécurité relatifs aux mots de passe utilisés dans l'application (complexité, longueur, durée de vie) et les règles de verrouillage des comptes en cas de tentatives de connexion échouées.

- **Préconditions :**

  - Le Super Administrateur est authentifié dans le système avec un compte disposant des droits nécessaires pour accéder et modifier les paramètres de sécurité système, y compris la politique de mot de passe.
...
- **Scénario principal :**
  ...
  1.  Le Super Administrateur se connecte à l'interface d'administration (UC 1 implicite).
  2.  Le Super Administrateur navigue dans le menu vers la section "Administration Système", "Sécurité", ou "Gestion des Utilisateurs", puis accède à la sous-section "Politique de mot de passe" ou "Paramètres de sécurité".
  3.  Le système affiche l'interface de configuration de la politique de mot de passe. Cette interface présente les paramètres actuellement configurés, sous forme de champs modifiables. Ces paramètres peuvent inclure (mais ne sont pas limités à) :
      ...
      - **Portée de la politique :**
        - Appliquer aux comptes administrateurs uniquement.
        - Appliquer aux comptes mutualistes uniquement.
        - Appliquer aux deux types de comptes (si la même politique est utilisée).
  4.  Le Super Administrateur visualise les paramètres actuels de la politique de mot de passe et de verrouillage.
  5.  Le Super Administrateur modifie les valeurs des paramètres selon les exigences de sécurité de la mutuelle.
  6.  Le Super Administrateur vérifie les modifications apportées aux règles.
  7.  Le Super Administrateur clique sur un bouton "Enregistrer", "Appliquer", "Mettre à jour la politique", ou similaire.
  ...
  11. Le système affiche un message de confirmation à l'Super Administrateur (ex: "Politique de mot de passe mise à jour avec succès. Les nouvelles règles sont maintenant appliquées.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation des modifications**
    ...
    - ... (Étapes 1 à 7 du scénario principal)
    - 8.a. Le Super Administrateur décide de ne pas enregistrer les modifications apportées à la politique.
    - 9.a. Le Super Administrateur clique sur un bouton "Annuler" ou quitte la page sans sauvegarder.
  ...
  - **Scénario Alternatif A2 : Paramètres invalides détectés lors de la validation**
    ...
    - 10.a. Le système affiche des messages d'erreur clairs à côté des champs concernés, indiquant pourquoi les valeurs sont invalides. Le Super Administrateur reste sur la page pour corriger les paramètres.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'enregistrement de la politique de mot de passe**
    ...
    - 12.e. Le système affiche un message d'erreur générique à l'Super Administrateur (ex: "Une erreur système s'est produite lors de la sauvegarde des paramètres de sécurité. La politique n'a pas été mise à jour."). L'opération échoue.

- **Points à considérer pour la suite :**
  - La politique de mot de passe est-elle la même pour les administrateurs et les mutualistes, ou peuvent-elles être différentes ? (Le scénario principal prévoit une option pour la portée).
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Mutualiste / Administrateur (tout utilisateur du système)

- **Description :** Permet à un utilisateur authentifié (Mutualiste ou Administrateur) de consulter la liste des notifications personnalisées générées par le système qui lui sont adressées. Ces notifications l'informent d'événements importants le concernant (messages reçus, échéances, changements de statut, alertes système pour les Admins, etc.).

- **Préconditions :**

  - L'utilisateur (Mutualiste ou Administrateur) est authentifié et connecté à son espace (UC 1 pour Mutualiste, authentification pour Admin).
...
- **Scénario principal :**
  ...
  1.  L'Utilisateur (Mutualiste ou Administrateur) se connecte au système via son interface respective.
...
- **Points à considérer pour la suite :**
  - Comment les notifications sont-elles _générées_ ? Sont-elles toutes automatiques (déclenchées par des événements système comme une nouvelle cotisation due) ou les administrateurs peuvent-ils en créer et en envoyer manuellement (UC 58) ?
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (ayant les droits de gestion des notifications)

- **Description :** Permet à un administrateur de configurer les règles d'envoi des notifications générées par le système, de visualiser l'historique des notifications envoyées, et potentiellement d'envoyer des notifications manuellement à des utilisateurs ou groupes d'utilisateurs.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder et gérer la section des notifications.
...
- **Postconditions :**
  ...
  - L'administrateur a consulté l'historique des notifications envoyées.
...
- **Scénario principal (Combinant Configuration, Historique, Envoi Manuel) :**
  ...
  2.  L'Administrateur navigue dans le menu vers la section "Administration Système", "Paramètres de communication", ou "Gestion des notifications".
  3.  Le système affiche l'interface de gestion des notifications. Cette interface peut être organisée en différentes sections :
      ...
      - **Section Configuration des notifications automatiques :**
        ...
        - Pour chaque type, options pour définir les destinataires (ex: Mutualiste concerné, Administrateur(s) du service X, Super Administrateur).
      ...
      - **Section Envoi de notifications manuelles/groupées (Optionnel) :**
        ...
        - Champs : Destinataire(s) (ex: sélectionner un mutualiste spécifique, un groupe de mutualistes par filtre, un administrateur, un rôle), Sujet/Titre, Contenu du message, Choix du canal.

  4.  L'Administrateur choisit l'action qu'il souhaite effectuer :

      - **Sous-Scénario Principal A : Configurer les notifications automatiques**

        - 5a. L'Administrateur accède à la section de Configuration.
        - 6a. Le système affiche les paramètres actuels.
        - 7a. L'Administrateur modifie les paramètres selon les besoins (ex: active une nouvelle notification, change le canal pour les rappels de cotisation, définit quels Admins sont notifiés des nouvelles réclamations).
        - 8a. L'Administrateur enregistre les modifications de configuration.
      ...
      - **Sous-Scénario Principal H : Consulter l'historique des notifications envoyées**
        ...
        - 5h. L'Administrateur accède à la section Historique.
        - 6h. Le système affiche la liste des notifications envoyées. L'Administrateur utilise les filtres (par date, type, destinataire...) et le tri pour rechercher et analyser l'activité des notifications (ex: vérifier si les rappels de paiement ont bien été envoyés, identifier des échecs d'envoi pour un canal spécifique).
        - 7h. (Optionnel) L'Administrateur peut cliquer sur une notification dans l'historique pour voir son contenu exact (potentiellement avec le contenu personnalisé s'il y a des variables) et les détails de l'envoi (heure exacte, statut final).

      - **Sous-Scénario Principal M : Envoyer une notification manuelle (si la fonctionnalité existe)**
        - 5m. L'Administrateur accède à la section d'Envoi manuel.
        - 6m. Le système affiche le formulaire de composition.
        - 7m. L'Administrateur sélectionne le(s) destinataire(s) (ex: recherche et sélectionne un mutualiste, choisit un groupe ou un filtre, sélectionne un administrateur ou un rôle).
        - 8m. L'Administrateur saisit le Sujet/Titre et le Contenu de la notification.
        - 9m. L'Administrateur choisit le ou les canaux d'envoi (système, email, SMS) parmi ceux disponibles.
        - 10m. L'Administrateur vérifie la notification et les destinataires.
        - 11m. L'Administrateur clique sur "Envoyer".
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de l'opération**
    ...
    - Applicable aux sous-scénarios A et M avant l'enregistrement/l'envoi. L'Administrateur annule l'action. Le système abandonne le processus.

  - **Scénario Alternatif A2 : Paramètres/Données invalides détectés**

    - Applicable aux sous-scénarios A (étape 9a) et M (étape 12m). La validation des données (configuration ou contenu/destinataires) échoue. Le système affiche des messages d'erreur spécifiques. L'Administrateur reste sur l'interface pour corriger.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la sauvegarde de la configuration ou de l'historique**
    ...
    - Le système enregistre l'erreur technique. Le système affiche un message d'erreur générique à l'Administrateur. L'opération (sauvegarde ou consultation) échoue.
  ...
  - **Scénario d'Exception E2 : Erreur système lors de l'envoi de notifications manuelles**
    ...
    - Le système enregistre l'erreur technique. L'Administrateur est informé qu'une erreur est survenue lors de l'envoi. L'historique peut enregistrer l'échec.
...
- **Postconditions :**
  ...
  - Les paramètres de configuration globaux du système sont mis à jour selon les modifications effectuées par le Super Administrateur.
...
- **Scénario principal :**
  ...
  1.  Le Super Administrateur se connecte à l'interface d'administration (UC 1 implicite).
  2.  Le Super Administrateur navigue dans le menu vers la section "Administration Système", "Configuration", "Paramètres Globaux", ou similaire.
  ...
  4.  Le Super Administrateur visualise les paramètres actuels de la configuration système.
  5.  Le Super Administrateur modifie les valeurs d'un ou plusieurs paramètres de configuration selon les besoins.
  6.  Le Super Administrateur vérifie les modifications apportées.
  7.  Le Super Administrateur clique sur un bouton "Enregistrer", "Sauvegarder la configuration", "Appliquer les paramètres", ou similaire.
  ...
  11. Le système affiche un message de confirmation à l'Super Administrateur (ex: "Configuration système mise à jour avec succès.").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation des modifications**
    ...
    - ... (Étapes 1 à 7 du scénario principal)
    - 8.a. Le Super Administrateur décide de ne pas enregistrer les modifications apportées à la configuration.
    - 9.a. Le Super Administrateur clique sur un bouton "Annuler" ou quitte la page sans sauvegarder.
    - 10.a. Le système abandonne les modifications en cours.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'enregistrement de la configuration**
    ...
    - 11.e. Le système enregistre l'erreur technique dans ses logs d'erreurs internes.
    - 12.e. Le système affiche un message d'erreur générique à l'Super Administrateur (ex: "Une erreur système s'est produite lors de la sauvegarde de la configuration. Les changements n'ont pas été enregistrés."). L'opération échoue.
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (avec les droits de consultation des rapports)

- **Description :** Permet à un administrateur d'accéder à la bibliothèque des rapports prédéfinis disponibles dans le système, de sélectionner un rapport et d'en afficher le contenu. Ces rapports fournissent des analyses structurées et des indicateurs détaillés basés sur les données du système.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder à la section "Rapports" et visualiser certains rapports.
...
- **Postconditions :**
  ...
  - L'administrateur a consulté la liste des rapports disponibles et/ou le contenu d'un rapport spécifique. Aucune modification des données sous-jacentes n'est effectuée.
  - La liste des rapports et/ou le contenu du rapport sélectionné est affiché à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Rapports", "Statistiques", "Analyse", ou similaire.
  3.  Le système affiche une liste des rapports disponibles auxquels l'Administrateur a accès, potentiellement organisée par catégories (ex: Adhérents, Finance, Services, Actes de Gestion). Pour chaque rapport, le système affiche son titre (ex: "Rapport Mensuel des Cotisations Perçues"), une brève description et potentiellement sa date de dernière mise à jour ou génération.
  4.  L'Administrateur consulte la liste des rapports disponibles.
  5.  L'Administrateur sélectionne le rapport qu'il souhaite visualiser en cliquant sur son titre ou un bouton "Visualiser".
  6.  (Optionnel) Si le rapport est un rapport dynamique ou paramétrable, le système peut présenter un formulaire demandant à l'Administrateur de spécifier des critères ou des paramètres pour générer le rapport (ex: sélectionner une période de date de début/fin, choisir un type de prestation, filtrer par statut de prêt).
  7.  L'Administrateur saisit les paramètres du rapport si nécessaire et valide (clique sur "Générer Rapport" ou "Appliquer").
  ...
  10. L'Administrateur consulte les informations, les statistiques et les analyses présentées dans le rapport pour obtenir des insights.
  11. (Optionnel) Depuis la vue du rapport, l'Administrateur peut avoir des options supplémentaires (ex: revenir à la liste des rapports, modifier les paramètres de génération, imprimer le rapport, ou exporter le rapport - ce dernier étant géré par l'UC 61).

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Aucun rapport disponible ou accessible pour cet Administrateur**

    - ... (Étapes 1 à 3 du scénario principal)
    - 4.a. Le système interroge la base de données mais ne trouve aucun rapport configuré ou accessible spécifiquement à cet Administrateur, ou la section Rapports est vide.
  ...
  - **Scénario Alternatif A2 : Rapport sélectionné introuvable ou non accessible après sélection dans la liste**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. Le système ne trouve pas le rapport sélectionné par l'Administrateur (ex: il a été supprimé juste avant) ou l'Administrateur n'a plus les droits d'y accéder.
  ...
  - **Scénario Alternatif A3 : Paramètres de rapport requis manquants ou invalides**
    ...
    - ... (Étapes 1 à 7 du scénario principal)
    - 8.a. L'Administrateur ne fournit pas les paramètres requis pour générer le rapport, ou les valeurs saisies sont invalides (ex: date de fin antérieure à la date de début, valeur numérique invalide).
    - 9.a. Le système affiche des messages d'erreur indiquant les paramètres manquants ou invalides. L'Administrateur est invité à corriger les paramètres dans le formulaire.
  ...
  - **Scénario Alternatif A4 : Aucune donnée pour générer le rapport avec les paramètres donnés**
    ...
    - 11.a. L'Administrateur prend connaissance de l'information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors du chargement de la liste des rapports ou de la visualisation d'un rapport**
    ...
    - 9.e. / 11.e. Le système affiche un message d'erreur générique à l'Administrateur (ex: "Une erreur s'est produite lors du chargement des rapports. Veuillez réessayer."). Les rapports ne peuvent pas être consultés.
...
- **Points à considérer pour la suite :**
  ...
  - L'accès à des rapports spécifiques est-il contrôlé par les rôles et permissions des administrateurs (UC 55) ?
  - Les rapports peuvent-ils être planifiés pour une génération automatique et envoyés par email (reporting planifié) ?
  - L'administrateur peut-il exporter le contenu des rapports dans différents formats (Excel, PDF) ? (UC 61).
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (avec les droits d'exportation appropriés)

- **Description :** Permet à un administrateur disposant des droits nécessaires d'extraire une sélection de données depuis le système (listes d'adhérents, détails de prêts, résultats de rapports, historique de transactions, etc.) et de les enregistrer dans un fichier téléchargeable, dans différents formats couramment utilisés.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et possède les droits d'exportation pour les types de données ou les rapports qu'il souhaite extraire.
  - Le système contient les données à exporter.
  - L'administrateur a identifié la source des données à exporter (une liste, un rapport, un filtre spécifique).
  - Le système supporte les formats d'exportation souhaités par l'administrateur.

- **Postconditions :**

  - Un fichier contenant les données exportées est généré par le système.
  - Le système propose le fichier généré au téléchargement par l'administrateur.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue vers la section du système contenant les données qu'il souhaite exporter. Cela peut être :
  ...
  3.  L'Administrateur sélectionne l'option ou le bouton "Exporter", "Télécharger", "Exporter au format...", ou similaire, qui est disponible dans la vue des données ou du rapport.
  ...
  5.  L'Administrateur configure les options d'exportation selon ses besoins et valide (clique sur "Générer et télécharger", "Exporter").
  ...
  8.  Une fois le fichier généré, le système initie le téléchargement du fichier via le navigateur web de l'Administrateur.
  9.  L'Administrateur télécharge le fichier sur son poste ou un emplacement réseau.
  10. Le système enregistre un événement détaillé dans les logs d'audit (UC 54) indiquant que l'exportation a eu lieu, par quel administrateur, à quelle date/heure, quel type de données a été exporté, le format, et potentiellement les filtres appliqués.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation par l'Administrateur**
    ...
    - 7.a. / 10.a. L'Administrateur décide d'annuler l'exportation (avant la génération ou pendant le téléchargement).
  ...
  - **Scénario Alternatif A3 : Format d'exportation non supporté pour ce type de données**
    ...
    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. L'Administrateur sélectionne un format (ex: PDF) qui n'est pas supporté pour l'exportation des données spécifiques sélectionnées (ex: seule l'exportation en CSV est disponible pour cette liste).
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération des données ou de la génération du fichier**
    ...
    - 11.e. Le système affiche un message d'erreur générique à l'Administrateur (ex: "Une erreur s'est produite lors de l'exportation des données. Veuillez réessayer plus tard."). Le fichier n'est pas généré ou n'est pas téléchargeable.
  ...
  - **Scénario d'Exception E2 : L'exportation prend trop de temps et expire**
    ...
    - 10.e. Le système annule le processus. L'Administrateur reçoit un message d'erreur indiquant que l'exportation a échoué en raison d'un délai d'attente. Le système pourrait suggérer de filtrer les données pour réduire le volume.
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (avec les droits d'importation appropriés)

- **Description :** Permet à un administrateur disposant des droits nécessaires d'uploader un fichier contenant des données structurées (ex: liste de nouveaux adhérents, mises à jour de cotisations, historique de prêts d'un ancien système) et de déclencher un processus d'importation pour créer ou mettre à jour des enregistrements dans le système.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et possède les droits pour importer les types de données souhaitées.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue vers la section "Administration Système", "Outils", "Importation de données", ou vers une section spécifique du module métier où l'importation est pertinente (ex: Module Adhérents > Fonctionnalités d'import).
  3.  Le système affiche l'interface d'importation. L'Administrateur sélectionne le type de données qu'il souhaite importer (ex: "Importer des Mutualistes", "Importer des Cotisations Historiques").
  ...
  5.  L'Administrateur clique sur un bouton "Sélectionner un fichier", "Uploader le fichier d'import", ou similaire.
  6.  L'Administrateur sélectionne le fichier de données (CSV, Excel, etc.) sur son poste de travail via l'explorateur de fichiers du système d'exploitation.
  7.  L'Administrateur valide la sélection du fichier. Le système télécharge le fichier.
  8.  Le système analyse le fichier uploaddé pour vérifier son format de base et sa structure (ex: nombre de colonnes, présence d'en-têtes). Une étape de mappage des colonnes du fichier aux champs du système peut être nécessaire et présentée à l'administrateur si le fichier n'a pas un format standard attendu.
  9.  Le système affiche un aperçu des premières lignes du fichier et signale les problèmes de format ou de structure initiaux. L'Administrateur vérifie que le fichier est correctement interprété. 10. L'Administrateur clique sur un bouton "Lancer l'importation", "Valider et importer", ou similaire. 11. Le système démarre le processus de traitement du fichier ligne par ligne. Pour chaque ligne, il :
      ...
      _ Nombre de lignes ignorées ou ayant échoué. \* Pour les lignes ayant échoué, la ligne concernée et la raison spécifique de l'échec (ex: "Mutualiste n° [Numéro] introuvable pour mise à jour", "Date de naissance invalide", "Identifiant mutualiste déjà existant"). 13. Le système affiche le rapport de résultat de l'importation à l'Administrateur. 14. Le système enregistre un événement détaillé dans les logs d'audit (UC 54) indiquant que l'importation a eu lieu, par qui, à quelle date/heure, quel type de données a été importé, le nom du fichier source, et un résumé du rapport de résultat (succès/échecs).

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation par l'Administrateur**

    - Applicable pendant l'upload (étape 7), le mappage/pré-validation (étape 9), ou potentiellement pendant le traitement réel si l'importation est un long processus visible (étape 11). L'Administrateur annule l'opération. Le système arrête le processus ; si le traitement était en cours, il peut indiquer qu'il est partiellement terminé.
  ...
  - **Scénario Alternatif A2 : Fichier invalide (format, structure, contenu initial)**
    ...
    - 10.a. Le système affiche un message d'erreur à l'Administrateur (ex: "Le fichier n'est pas valide ou le format n'est pas correct.") et l'importation ne peut pas démarrer.
  ...
  - **Scénario d'Exception E1 : Erreur système critique pendant le traitement de l'importation**
    ...
    - 13.e. Le processus d'importation s'arrête anormalement. Le système enregistre l'erreur technique. Le rapport de résultat peut être incomplet ou non généré, indiquant un échec général. L'Administrateur reçoit un message d'erreur générique.

  - **Scénario d'Exception E2 : Le rapport de résultat ne peut pas être généré ou affiché**
    - ... (Après l'étape 12 du scénario principal)
    - 13.e. Le système rencontre une erreur lors de la tentative de compiler ou d'afficher le rapport de résultat de l'importation à l'Administrateur.
    - 14.e. Le système enregistre l'erreur. L'Administrateur est informé qu'une erreur s'est produite lors de la génération du rapport final, même si l'importation elle-même a pu réussir ou échouer partiellement.
...
- **Points à considérer pour la suite :**
  ...
  - Les importations de gros fichiers peuvent-elles s'exécuter en arrière-plan pour ne pas bloquer l'interface utilisateur ? Comment l'administrateur est-il informé de la fin d'une importation en arrière-plan ?
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (avec les droits d'archivage des données)

- **Description :** Permet à un administrateur disposant des droits nécessaires d'exécuter un processus pour marquer comme archivées ou déplacer vers un stockage secondaire les données du système qui ne sont plus activement utilisées (selon des critères prédéfinis, ex: ancienneté, statut clôturé), afin d'optimiser la performance du système principal et de respecter les politiques de conservation des données.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et possède les droits d'administration pour l'archivage des données.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Administration Système", "Maintenance", "Gestion des données", ou "Archivage".
  ...
  5.  L'Administrateur sélectionne le type de données qu'il souhaite archiver (ou peut potentiellement sélectionner plusieurs types).
  6.  (Optionnel) L'Administrateur peut ajuster les critères d'archivage (si les règles le permettent) pour cette exécution spécifique (ex: choisir une période de date différente, exclure certains sous-types).
  7.  L'Administrateur lance le processus d'archivage (clique sur "Démarrer l'archivage", "Exécuter l'archivage pour [Type de données]").
  ...
  9.  Si le processus est en arrière-plan, l'interface peut afficher son statut (En cours, Terminé, Échoué). L'Administrateur peut être notifié de la fin du processus.
  ...
  11. Le système affiche le rapport de résumé à l'Administrateur dans l'interface d'archivage ou l'envoie par un autre canal.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation du processus d'archivage par l'Administrateur**

    - Applicable si le processus est long et offre une option d'interruption. L'Administrateur annule l'exécution en cours. Le système tente d'arrêter le processus proprement, indiquant que l'archivage est incomplet ou annulé dans le rapport final.
  ...
  - **Scénario Alternatif A2 : Aucune donnée éligible à l'archivage selon les règles**
    ...
    - 9.a. Le système affiche un message informant l'Administrateur qu'il n'y a aucune donnée à archiver pour le moment avec ces critères. Le processus se termine sans archiver d'éléments.
  ...
  - **Scénario d'Exception E1 : Erreur système critique pendant l'exécution de l'archivage**
    ...
    - 10.e. Le processus d'archivage s'arrête anormalement. Le système enregistre l'erreur technique dans ses logs internes. L'Administrateur est informé d'un échec global ou partiel avec une erreur système. L'état des données (certaines peut-être partiellement archivées) peut nécessiter une intervention technique.
  ...
  - **Scénario d'Exception E2 : Le rapport de résumé de l'archivage ne peut pas être généré**
    ...
    - 12.e. Le système enregistre l'erreur. L'Administrateur est informé qu'il y a eu un problème lors de la génération du rapport, même si le processus d'archivage a pu se terminer.
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (avec les droits d'administration système/sauvegarde)

- **Description :** Permet à un administrateur disposant des droits nécessaires de déclencher manuellement l'exécution d'un processus de sauvegarde de la base de données de l'application. Cette opération crée une copie à un instant T de l'intégralité (ou d'une partie) des données stockées, à des fins de sécurité et de récupération.

- **Préconditions :**

  - L'administrateur est authentifié dans le système avec un compte disposant des droits suffisants pour initier des opérations de sauvegarde de la base de données.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Administration Système", "Maintenance", "Sauvegarde et Restauration", ou similaire.
  ...
  4.  L'Administrateur localise et clique sur l'option ou le bouton "Lancer une sauvegarde maintenant", "Exécuter sauvegarde manuelle", ou similaire.
  ...
  6.  L'Administrateur confirme le lancement de la sauvegarde manuelle.
  ...
  11. Le système enregistre un événement détaillé dans les logs d'audit (UC 54) indiquant que cet administrateur a déclenché une sauvegarde manuelle, à quel moment, et quel a été son résultat (succès ou échec).
  12. Le système affiche un message de confirmation ou de rapport final à l'Administrateur dans l'interface (ex: "Sauvegarde manuelle de la base de données terminée avec succès à [Heure]. Fichier : [Nom du fichier], Taille : [Taille].", ou "Échec de la sauvegarde de la base de données. Voir les détails dans le journal des sauvegardes.").

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation du processus par l'Administrateur**

    - Applicable si l'opération de sauvegarde peut être interrompue. L'Administrateur annule l'exécution en cours. Le système tente d'arrêter le processus proprement et l'enregistre comme Annulé dans le journal des sauvegardes.

  - **Scénario Alternatif A2 : Mécanisme de sauvegarde non configuré ou non opérationnel**

    - ... (Étapes 1 à 4 du scénario principal)
    - 5.a. Lorsque l'Administrateur clique pour lancer la sauvegarde, le système détecte que le mécanisme technique de sauvegarde n'est pas configuré, qu'il y a une erreur dans la configuration, ou que les outils nécessaires ne sont pas accessibles/opérationnels.
    - 6.a. Le système affiche un message d'erreur à l'Administrateur (ex: "Le mécanisme de sauvegarde n'est pas correctement configuré. Impossible de lancer la sauvegarde."). L'opération ne peut pas démarrer.
  ...
  - **Scénario d'Exception E1 : Erreur système pendant l'exécution de la sauvegarde**
    ...
    - 11.e. Le statut de la sauvegarde est enregistré comme Échec dans le journal des sauvegardes. Le système affiche un message d'échec détaillé ou générique à l'Administrateur.
  ...
  - **Scénario d'Exception E2 : La base de données est inaccessible ou instable au moment de la sauvegarde**
    ...
    - 9.e. Le processus échoue immédiatement ou rapidement. Le système enregistre l'erreur. L'Administrateur est informé que la sauvegarde n'a pas pu être effectuée en raison d'un problème avec la base de données.
...
- **Points à considérer pour la suite :**
  ...
  - Quels détails techniques de la sauvegarde sont visibles par l'Administrateur dans le journal des sauvegardes (date, heure, taille, statut, message d'erreur si échec, type de sauvegarde - complète/incrémentale si applicable) ?
...
- **Module :** 16 - Gestion des Utilisateurs de l'Application
- **Acteur principal :** Administrateur (avec les droits critiques de restauration de la base de données)

- **Description :** Permet à un administrateur disposant des droits appropriés d'utiliser un fichier de sauvegarde valide pour remplacer le contenu actuel de la base de données de l'application. Cette opération ramène le système à l'état dans lequel il se trouvait au moment de la sauvegarde et est utilisée en cas de corruption majeure des données ou de perte d'informations irréversible.

- **Préconditions :**

  - L'administrateur est authentifié dans le système avec un compte disposant des droits très élevés pour effectuer une restauration de la base de données.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration (si l'interface est toujours accessible malgré l'incident) ou accède à une interface de maintenance système séparée.
  2.  L'Administrateur navigue vers la section "Administration Système", "Maintenance", "Sauvegarde et Restauration".
  ...
  4.  L'Administrateur consulte la liste et sélectionne le fichier de sauvegarde à utiliser pour la restauration (en se basant sur la date/heure souhaitée).
  5.  L'Administrateur clique sur l'option ou le bouton "Restaurer", "Restaurer à partir de ce fichier", ou similaire.
  ...
  7.  L'Administrateur, comprenant pleinement les risques, confirme le lancement de l'opération de restauration.
  ...
  13. Le système enregistre un événement détaillé dans les logs d'audit (UC 54) indiquant que cet administrateur a déclenché une restauration, quand, quel fichier a été utilisé, et quel a été le résultat (succès ou échec).
  ...
  15. Le système affiche un message de confirmation ou de rapport final à l'Administrateur (ex: "Restauration de la base de données terminée avec succès. Le système est maintenant en ligne.", ou "La restauration a échoué. Une intervention technique est nécessaire."). L'application redevient accessible aux utilisateurs avec les données restaurées (si la restauration a réussi et que le redémarrage a fonctionné).

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation par l'Administrateur (avant confirmation critique)**

    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. L'Administrateur lit l'avertissement et décide de ne pas procéder à la restauration.
    - 8.a. L'Administrateur annule l'opération (ferme la boîte de dialogue, clique sur Annuler). Le système abandonne le processus.
  ...
  - **Scénario Alternatif A2 : Fichier de sauvegarde sélectionné introuvable, invalide ou corrompu**
    ...
    - 7.a. Le système affiche un message d'erreur à l'Administrateur (ex: "Fichier de sauvegarde introuvable ou corrompu. Veuillez en sélectionner un autre."). La restauration ne démarre pas.
  ...
  - **Scénario d'Exception E1 : Erreur système critique pendant l'exécution de la restauration**
    ...
    - 12.e. Le statut de la restauration est enregistré comme Échec. L'Administrateur reçoit un message d'échec (potentiellement technique). **Attention :** Après un échec de restauration, la base de données peut être dans un état instable ou corrompu, nécessitant souvent une intervention technique manuelle d'urgence.
  ...
  - **Scénario d'Exception E2 : La base de données ou le système est dans un état empêchant la restauration**
    ...
    - 10.e. Le processus échoue immédiatement ou rapidement. Le système enregistre l'erreur. L'Administrateur est informé que la restauration n'a pas pu être lancée en raison de l'état actuel du système ou de la base de données.
  ...
  - **Scénario d'Exception E3 : L'application ne redémarre pas ou ne fonctionne pas correctement après une restauration réussie (techniquement parlant)**
    ...
    - 16.e. L'Administrateur voit que le système n'est pas pleinement opérationnel malgré le rapport de succès de la restauration de la base de données. Cela nécessite une investigation et des actions correctives au niveau de l'application et de l'infrastructure.
...
- **Module :** 17 - Gestion Financière & Trésorerie Interne
- **Acteur principal :** Administrateur (ayant les droits financiers)

- **Description :** Permet à un administrateur d'enregistrer formellement une dépense opérationnelle ou administrative (ne concernant pas les prestations aux mutualistes) engagée par la mutuelle. Cela inclut la saisie des détails de la dépense (montant, date, bénéficiaire, catégorie, justification).

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour enregistrer les dépenses de fonctionnement.
...
- **Postconditions :**
  ...
  - L'enregistrement est associé à l'administrateur qui l'a saisi et à la date de saisie.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Trésorerie", ou "Dépenses de fonctionnement".
  3.  Le système affiche l'interface de gestion des dépenses de fonctionnement, potentiellement avec la liste des dépenses récentes (UC 67 implicite) et une option pour enregistrer une nouvelle dépense. L'Administrateur clique sur "Enregistrer une nouvelle dépense".
  4.  Le système affiche un formulaire de saisie pour la dépense de fonctionnement.
  5.  L'Administrateur saisit les informations requises :
  ...
  6.  (Optionnel) L'Administrateur peut indiquer le mode de paiement (ex: Virement Bancaire, Chèque, Caisse - si la dépense a été payée directement en liquide depuis une caisse gérée dans le système).
  7.  (Optionnel) L'Administrateur peut joindre un justificatif numérique (facture scannée, reçu).
  8.  L'Administrateur vérifie les informations saisies.
  9.  L'Administrateur clique sur un bouton "Enregistrer la dépense".
  ...
  12. Le système associe l'enregistrement à l'administrateur qui a effectué la saisie et à la date/heure de la saisie.
  ...
  15. Le système affiche un message de confirmation à l'Administrateur (ex: "Dépense enregistrée avec succès.").

- **Scénarios alternatifs et d'exception :**

  - **Scénario Alternatif A1 : Annulation de la saisie par l'Administrateur**

    - ... (Étapes 1 à 9 du scénario principal)
    - 10.a. L'Administrateur décide de ne pas enregistrer la dépense.
    - 11.a. L'Administrateur clique sur "Annuler" ou quitte le formulaire.
  ...
  - **Scénario Alternatif A2 : Données manquantes ou invalides détectées lors de la validation**
    ...
    - 12.a. Le système affiche des messages d'erreur clairs à côté des champs concernés. L'Administrateur reste sur le formulaire pour corriger.
  ...
  - **Scénario Alternatif A3 : Catégorie de dépense introuvable ou inactive**
    ...
    - 12.a. Le système affiche un message d'erreur et demande à l'Administrateur de sélectionner une catégorie valide.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'enregistrement de la dépense**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que la dépense n'a pas pu être enregistrée pour le moment. L'opération échoue.
...
- **Points à considérer pour la suite :**
  ...
  - L'Administrateur peut-il modifier ou supprimer une dépense enregistrée ? (Nécessiterait des UCs spécifiques).
  - Comment les dépenses enregistrées via cet UC sont-elles intégrées dans les rapports financiers globaux (UC 74) ?
  - Y a-t-il une validation des droits de l'Administrateur pour enregistrer des dépenses au-delà d'un certain montant ?
...
- **Module :** 17 - Gestion Financière & Trésorerie Interne
- **Acteur principal :** Administrateur (ayant les droits financiers/comptables)

- **Description :** Permet à un administrateur de consulter une liste ou un tableau des dépenses de fonctionnement enregistrées dans le système (via UC 66). L'administrateur peut utiliser des filtres et des options de tri pour affiner la liste affichée.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour visualiser les dépenses de fonctionnement.
...
- **Postconditions :**
  ...
  - L'administrateur a consulté la liste des dépenses de fonctionnement enregistrées. Aucune modification des données n'est effectuée par cette consultation.
  - La liste des dépenses de fonctionnement (potentiellement filtrée et triée) est affichée à l'écran de l'administrateur.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Trésorerie", "Dépenses de fonctionnement", ou accède à un rapport/une vue de liste dédié.
  ...
  4.  L'Administrateur visualise la liste par défaut des dépenses.
  5.  L'Administrateur utilise les options de filtrage et de recherche disponibles pour affiner la liste (ex: filtrer par période de date, par catégorie de dépense, rechercher un bénéficiaire ou un mot clé dans la description, filtrer par montant).
  6.  L'Administrateur utilise les options de tri disponibles (ex: trier par date, par montant, par catégorie).
  ...
  8.  L'Administrateur consulte la liste filtrée, triée et paginée (si nécessaire) des dépenses de fonctionnement pour trouver les informations recherchées, vérifier des enregistrements spécifiques ou obtenir un aperçu d'une période donnée.
  9.  (Optionnel) L'Administrateur peut cliquer sur une dépense spécifique dans la liste pour afficher ses détails complets (y compris les justificatifs si présents, lien vers UC 66 ou une vue détaillée).
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucune dépense enregistrée (ou correspondant aux filtres/recherche)**
    ...
    - 10.a. L'Administrateur prend connaissance de l'information.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération ou de l'affichage des dépenses**
    ...
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que la liste des dépenses n'a pas pu être chargée pour le moment.
...
- **Description :** Permet à un administrateur de consulter des graphiques ou des tableaux de synthèse qui présentent la répartition des dépenses de fonctionnement (enregistrées via UC 66) sur une période donnée, généralement par catégorie de dépense. Cela aide à l'analyse et au contrôle budgétaire.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour visualiser les rapports de répartition des dépenses.
...
- **Postconditions :**
  ...
  - Un rapport (graphique, tableau croisé dynamique, etc.) présentant la répartition des dépenses de fonctionnement sur une période et selon une catégorie donnée est affiché à l'écran de l'administrateur.
  - L'administrateur a une vue synthétique de la structure des dépenses.
  - Aucune modification des données n'est effectuée.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Rapports", "Analyse des dépenses", ou accède directement à ce rapport spécifique depuis la liste des rapports (UC 60).
  3.  Le système affiche l'interface de ce rapport. Si le rapport est paramétrable (ce qui est typique pour une répartition sur période), le système présente un formulaire demandant à l'Administrateur de spécifier les critères.
  4.  L'Administrateur spécifie la période pour laquelle il souhaite visualiser la répartition des dépenses (ex: mois, trimestre, année fiscale, période personnalisée). Il peut aussi spécifier le critère de répartition (généralement par catégorie de dépense, mais potentiellement par bénéficiaire si pertinent).
  5.  L'Administrateur valide les paramètres (clique sur "Générer Rapport", "Appliquer les filtres").
  ...
  9.  Le système affiche le rapport visuel ou tabulaire à l'écran de l'Administrateur.
  10. L'Administrateur consulte le rapport pour comprendre où vont les dépenses de fonctionnement et identifier les postes de coûts importants ou les évolutions notables.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Paramètres de rapport requis manquants ou invalides (géré par UC 60 si accessible via liste rapports)**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur ne fournit pas les paramètres requis (ex: période) ou les valeurs saisies sont invalides.
    - 7.a. Le système affiche des messages d'erreur. L'Administrateur doit corriger les paramètres.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération/agrégation des données ou de la génération du rapport**
    ...
    - 9.e. Le système enregistre l'erreur technique dans ses journaux.
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que le rapport n'a pas pu être généré ou affiché pour le moment.
...
- **Module :** 17 - Gestion Financière & Trésorerie Interne
- **Acteur principal :** Administrateur (avec les droits de gestion de caisse)

- **Description :** Permet à un administrateur d'enregistrer une transaction qui augmente le solde de la caisse physique (argent liquide) gérée par la mutuelle. Il documente la source de l'entrée, le montant, la date et la justification.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour enregistrer les mouvements de caisse.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Trésorerie", "Gestion de Caisse", ou "Mouvements de Caisse".
  3.  Le système affiche l'interface de gestion de caisse, potentiellement avec le solde actuel (UC 71 implicite) et les mouvements récents (UC 72 implicite), ainsi que des options pour enregistrer une entrée ou une sortie. L'Administrateur clique sur "Enregistrer une entrée en caisse".
  ...
  6.  (Optionnel) L'Administrateur peut lier cette entrée à un mutualiste spécifique si la source est identifiable.
  7.  (Optionnel) L'Administrateur peut joindre un justificatif numérique (reçu, bordereau).
  8.  L'Administrateur vérifie les informations saisies.
  9.  L'Administrateur clique sur un bouton "Enregistrer l'entrée".
  ...
  13. Le système associe l'enregistrement à l'administrateur qui a effectué la saisie et à la date/heure de la saisie.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de la saisie par l'Administrateur**
    ...
    - ... (Étapes 1 à 9 du scénario principal)
    - 10.a. L'Administrateur décide de ne pas enregistrer l'entrée.
    - 11.a. L'Administrateur clique sur "Annuler" ou quitte le formulaire.
    - 12.a. Le système abandonne le processus de saisie.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'enregistrement de l'entrée en caisse**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que l'entrée n'a pas pu être enregistrée pour le moment. L'opération échoue, le solde n'est pas mis à jour.
...
- **Description :** Permet à un administrateur d'enregistrer une transaction qui diminue le solde de la caisse physique (argent liquide) gérée par la mutuelle. Il documente la destination/le motif de la sortie, le montant, la date et la justification.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Trésorerie", "Gestion de Caisse", ou "Mouvements de Caisse".
  3.  Le système affiche l'interface de gestion de caisse, potentiellement avec le solde actuel (UC 71 implicite) et les mouvements récents (UC 72 implicite). L'Administrateur clique sur "Enregistrer une sortie de caisse".
  ...
  6.  (Optionnel) L'Administrateur peut lier cette sortie à une dépense de fonctionnement enregistrée précédemment (UC 66) si c'est la source de la sortie.
  7.  (Optionnel) L'Administrateur peut joindre un justificatif numérique (reçu, facturette).
  8.  L'Administrateur vérifie les informations saisies et s'assure que le montant ne dépasse pas le solde actuel affiché.
  9.  L'Administrateur clique sur un bouton "Enregistrer la sortie".
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Annulation de la saisie par l'Administrateur**
    ...
    - ... (Étapes 1 à 9 du scénario principal)
    - 10.a. L'Administrateur décide de ne pas enregistrer la sortie.
    - 11.a. L'Administrateur clique sur "Annuler" ou quitte le formulaire.
    - 12.a. Le système abandonne le processus de saisie.
  ...
  - **Scénario Alternatif A3 : Montant de la sortie supérieur au solde courant de la caisse**
    ...
    - 12.a. Le système affiche un message d'erreur clair (ex: "Le montant de la sortie ([Montant Saisi]) dépasse le solde actuel de la caisse ([Solde Actuel]). Impossible d'enregistrer cette sortie."). L'opération est bloquée. L'Administrateur doit corriger le montant ou vérifier les entrées/sorties précédentes.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'enregistrement de la sortie en caisse**
    ...
    - 13.e. Le système enregistre l'erreur technique dans ses logs.
    - 14.e. Le système affiche un message d'erreur générique à l'Administrateur indiquant que la sortie n'a pas pu être enregistrée pour le moment. L'opération échoue, le solde n'est pas mis à jour.
...
- **Description :** Permet à un administrateur de visualiser le solde actuel (balance) de la caisse physique telle qu'enregistrée dans le système. Ce solde est le résultat de toutes les entrées (UC 69) et sorties (UC 70) de caisse validées jusqu'à présent.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour consulter l'état de caisse.
  - Une caisse physique est configurée et gérée dans le système.
  - Le système contient des enregistrements de mouvements de caisse (entrées/sorties).

- **Postconditions :**

  - Le solde actuel de la caisse physique est affiché à l'écran de l'administrateur.
  - Aucune modification des données n'est effectuée.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Trésorerie", "Gestion de Caisse", ou accède à une vue/un tableau de bord affichant les informations de caisse.
  3.  (Optionnel) Si plusieurs caisses sont gérées, l'Administrateur sélectionne la caisse spécifique dont il souhaite voir le solde.
  ...
  6.  Le système affiche clairement le solde calculé à l'écran de l'Administrateur (ex: "Solde Caisse Principale : [Montant Courant] XOF").
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Aucune caisse configurée ou accessible**
    ...
    - ... (Étapes 1 à 2 du scénario principal)
    - 3.a. Le système ne trouve aucune caisse configurée ou accessible pour cet Administrateur.
  ...
  - **Scénario Alternatif A2 : Aucune entrée/sortie enregistrée pour la caisse**
    ...
    - 7.a. L'Administrateur prend connaissance du solde nul.
  ...
  - **Scénario d'Exception E1 : Erreur système lors du calcul ou de la récupération du solde**
    ...
    - 7.e. Le système enregistre l'erreur technique dans ses journaux.
    - 8.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que le solde de caisse n'a pas pu être chargé pour le moment.
...
- **Module :** 17 - Gestion Financière & Trésorerie Interne
- **Acteur principal :** Administrateur (avec les droits financiers/comptables)

- **Description :** Permet à un administrateur de consulter des rapports récapitulatifs sur les mouvements de la caisse physique (entrées et sorties) pour une période donnée. Ces rapports fournissent des totaux, des soldes d'ouverture et de clôture, et une vue synthétique de l'activité de caisse.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour visualiser les rapports de caisse.
  - Une caisse physique est configurée et gérée dans le système.
  - Le système contient des enregistrements de mouvements de caisse (entrées/sorties) pour la période concernée.

- **Postconditions :**

  - Un rapport récapitulatif de caisse pour une période spécifiée est affiché à l'écran de l'administrateur.
...
- **Scénario principal :**
  ...
  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Rapports", "Rapports de Caisse", ou accède directement à ce rapport depuis la liste des rapports (UC 60).
  3.  (Optionnel) Si plusieurs caisses sont gérées, l'Administrateur sélectionne la caisse spécifique dont il souhaite voir le rapport.
  4.  Le système affiche l'interface de ce rapport. Le système présente un formulaire demandant à l'Administrateur de spécifier la période pour le rapport.
  5.  L'Administrateur spécifie la période pour laquelle il souhaite générer le rapport (ex: Journée du [Date], Semaine du [Date Début] au [Date Fin], Mois de [Mois], Période personnalisée).
  6.  L'Administrateur valide les paramètres (clique sur "Générer Rapport", "Appliquer la période").
  ...
  10. Le système affiche le rapport récapitulatif à l'écran de l'Administrateur.
  11. L'Administrateur consulte le rapport pour analyser les flux de caisse sur la période et vérifier les soldes d'ouverture/clôture.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Paramètres de période manquants ou invalides**
    ...
    - ... (Étapes 1 à 6 du scénario principal)
    - 7.a. L'Administrateur ne fournit pas la période ou les valeurs sont invalides (ex: date de fin antérieure à la date de début).
    - 8.a. Le système affiche des messages d'erreur. L'Administrateur doit corriger les paramètres.
  ...
  - **Scénario d'Exception E1 : Erreur système lors du calcul ou de la génération du rapport**
    ...
    - 11.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que le rapport récapitulatif n'a pas pu être généré ou affiché.
...
- **Module :** 17 - Gestion Financière & Trésorerie Interne
- **Acteur principal :** Administrateur (avec les droits d'analyse financière)

- **Description :** Permet à un administrateur de consulter des analyses prospectives ou des visualisations de tendances basées sur les mouvements de trésorerie (potentiellement englobant la caisse physique, mais aussi les flux bancaires, etc., selon la définition de "caisse" dans ce contexte - assumons une vue plus large des flux de trésorerie si le terme "projections" est utilisé). Ces analyses aident à anticiper les besoins futurs et à comprendre les dynamiques des flux financiers.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder aux rapports de projections et tendances financières.
...
- **Postconditions :**
  ...
  - Un rapport ou une visualisation des projections et tendances de trésorerie est affiché à l'écran de l'administrateur.
  - L'administrateur a une vision prospective ou historique analysée des flux financiers.
  - Aucune modification des données n'est effectuée.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Analyse Financière", "Projections Trésorerie", ou accède directement à ce rapport depuis la liste des rapports (UC 60).
  3.  Le système affiche l'interface de ce rapport/analyse. Le système peut présenter un formulaire demandant à l'Administrateur de spécifier les paramètres de l'analyse.
  4.  L'Administrateur spécifie les critères pour l'analyse :
  ...
  5.  L'Administrateur valide les paramètres (clique sur "Générer Analyse", "Appliquer").
  ...
  9.  Le système affiche le rapport ou la visualisation à l'écran de l'Administrateur.
  10. L'Administrateur consulte l'analyse pour identifier les dynamiques financières passées, anticiper les périodes de flux tendus ou excédentaires, et éclairer les décisions de gestion de trésorerie.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario Alternatif A1 : Paramètres de rapport requis manquants ou invalides (géré par UC 60 si accessible via liste rapports)**
    ...
    - ... (Étapes 1 à 5 du scénario principal)
    - 6.a. L'Administrateur ne fournit pas les paramètres requis ou les valeurs sont invalides.
    - 7.a. Le système affiche des messages d'erreur. L'Administrateur doit corriger les paramètres.
  ...
  - **Scénario d'Exception E1 : Erreur système lors de la récupération/analyse des données ou de la génération du rapport**
    ...
    - 9.e. Le système enregistre l'erreur technique.
    - 10.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que l'analyse n'a pas pu être générée ou affichée.
...
- **Points à considérer pour la suite :**
  ...
  - L'Administrateur peut-il ajuster les modèles ou les hypothèses des projections ?
...
- **Module :** 17 - Gestion Financière & Trésorerie Interne
- **Acteur principal :** Administrateur (avec les droits d'accès aux rapports financiers globaux)

- **Description :** Fournit à un administrateur une vue d'ensemble agrégée et synthétique de la situation financière globale de la mutuelle, basée sur les données de la veille (J-1). Ce rapport ou tableau de bord consolidé inclut des indicateurs clés sur les actifs, les passifs, les revenus, les dépenses et les liquidités disponibles.

- **Préconditions :**

  - L'administrateur est authentifié dans le système et dispose des droits nécessaires pour accéder aux rapports financiers globaux.
...
- **Postconditions :**
  ...
  - Un rapport consolidé ou un tableau de bord affichant la santé financière de la mutuelle à la date de la veille (J-1) est affiché à l'écran de l'administrateur.
  - L'administrateur a une vision globale et à jour (de la veille) de la situation financière.
  - Aucune modification des données n'est effectuée.

- **Scénario principal :**

  1.  L'Administrateur se connecte à l'interface d'administration.
  2.  L'Administrateur navigue dans le menu vers la section "Gestion Financière", "Rapports", "Tableau de Bord Financier", ou accède directement à ce rapport spécifique.
  ...
  4.  L'Administrateur consulte les différents indicateurs, tableaux et graphiques synthétiques présentés sur ce tableau de bord financier pour évaluer la santé financière globale de la mutuelle à la fin de la journée précédente.
...
- **Scénarios alternatifs et d'exception :**
  ...
  - **Scénario d'Exception E1 : Erreur système lors de l'agrégation ou de l'affichage des données financières**
    ...
    - 5.e. Le système enregistre l'erreur technique dans ses journaux.
    - 6.e. Le système affiche un message d'erreur générique à l'Administrateur l'informant que le rapport de santé financière n'a pas pu être généré ou affiché pour le moment.
...
- **Points à considérer pour la suite :**
  ...
  - L'accès à ce rapport est-il limité à des administrateurs financiers ou de haut niveau ?
